(function (factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof globalThis['kotlin-kotlin-stdlib'] === 'undefined') {
      throw new Error("Error loading module 'kotlin-wrappers-kotlin-css-js-ir'. Its dependency 'kotlin-kotlin-stdlib' was not found. Please, check whether 'kotlin-kotlin-stdlib' is loaded prior to 'kotlin-wrappers-kotlin-css-js-ir'.");
    }
    globalThis['kotlin-wrappers-kotlin-css-js-ir'] = factory(typeof globalThis['kotlin-wrappers-kotlin-css-js-ir'] === 'undefined' ? {} : globalThis['kotlin-wrappers-kotlin-css-js-ir'], globalThis['kotlin-kotlin-stdlib']);
  }
}(function (_, kotlin_kotlin) {
  'use strict';
  //region block: imports
  var imul = Math.imul;
  var repeat = kotlin_kotlin.$_$.y8;
  ...
  var startsWith_0 = kotlin_kotlin.$_$.a9;
  ...
  var Regex_init_$Create$_0 = kotlin_kotlin.$_$.y;
  var objectCreate = kotlin_kotlin.$_$.a8;
  var lazy = kotlin_kotlin.$_$.ja;
  var coerceIn = kotlin_kotlin.$_$.i8;
  ...
  var substringBefore = kotlin_kotlin.$_$.c9;
  var toDouble = kotlin_kotlin.$_$.e9;
  var numberToInt = kotlin_kotlin.$_$.z7;
  var endsWith = kotlin_kotlin.$_$.v8;
  var substringBefore_0 = kotlin_kotlin.$_$.b9;
  var endsWith_0 = kotlin_kotlin.$_$.w8;
  var get_PI = kotlin_kotlin.$_$.f8;
  var numberRangeToNumber = kotlin_kotlin.$_$.x7;
  var substring = kotlin_kotlin.$_$.d9;
  var toInt_0 = kotlin_kotlin.$_$.h9;
  var charSequenceGet = kotlin_kotlin.$_$.y6;
  ...
  var joinToString_0 = kotlin_kotlin.$_$.j5;
  ...
  var KProperty0 = kotlin_kotlin.$_$.p8;
  var emptySet = kotlin_kotlin.$_$.e5;
  //endregion
  //region block: pre-declaration
  initMetadataForCompanion(Companion);
  initMetadataForClass(CssValue, 'CssValue');
  initMetadataForClass(LinearDimension, 'LinearDimension', VOID, CssValue);
  initMetadataForClass(Align, 'Align', VOID, Enum);
  initMetadataForClass(Appearance, 'Appearance', VOID, Enum);
  initMetadataForClass(Visibility, 'Visibility', VOID, Enum);
  initMetadataForClass(BackgroundAttachment, 'BackgroundAttachment', VOID, Enum);
  initMetadataForClass(BackgroundClip, 'BackgroundClip', VOID, Enum);
  initMetadataForCompanion(Companion_0);
  initMetadataForClass(RGBA, 'RGBA');
  initMetadataForClass(HSLA, 'HSLA');
  initMetadataForClass(Color, 'Color', VOID, CssValue);
  initMetadataForCompanion(Companion_1);
  initMetadataForClass(Image, 'Image', VOID, CssValue);
  initMetadataForClass(BackgroundOrigin, 'BackgroundOrigin', VOID, Enum);
  initMetadataForClass(BackgroundRepeat, 'BackgroundRepeat', VOID, Enum);
  initMetadataForClass(BorderCollapse, 'BorderCollapse', VOID, Enum);
  initMetadataForClass(BorderStyle, 'BorderStyle', VOID, Enum);
  initMetadataForClass(BoxSizing, 'BoxSizing', VOID, Enum);
  initMetadataForClass(Clear, 'Clear', VOID, Enum);
  initMetadataForClass(Contain, 'Contain', VOID, Enum);
  initMetadataForClass(QuotedString, 'QuotedString', VOID, CssValue);
  ...
  initMetadataForClass(FlexBasis, 'FlexBasis', VOID, CssValue);
  initMetadataForClass(FlexDirection, 'FlexDirection', VOID, Enum);
  initMetadataForClass(FlexWrap, 'FlexWrap', VOID, Enum);
  initMetadataForClass(Float, 'Float', VOID, Enum);
  initMetadataForClass(FontStyle, 'FontStyle', VOID, Enum);
  initMetadataForCompanion(Companion_3);
  initMetadataForClass(FontWeight, 'FontWeight', VOID, CssValue);
  initMetadataForCompanion(Companion_4);
  initMetadataForClass(GridAutoColumns, 'GridAutoColumns', VOID, CssValue);
  initMetadataForCompanion(Companion_5);
  initMetadataForClass(GridAutoFlow, 'GridAutoFlow', VOID, CssValue);
  initMetadataForCompanion(Companion_6);
  initMetadataForClass(GridAutoRows, 'GridAutoRows', VOID, CssValue);
  initMetadataForCompanion(Companion_7);
  initMetadataForClass(GridColumn, 'GridColumn', VOID, CssValue);
  initMetadataForCompanion(Companion_8);
  initMetadataForClass(GridColumnEnd, 'GridColumnEnd', VOID, CssValue);
  initMetadataForCompanion(Companion_9);
  initMetadataForClass(GridColumnStart, 'GridColumnStart', VOID, CssValue);
  initMetadataForCompanion(Companion_10);
  initMetadataForClass(GridRow, 'GridRow', VOID, CssValue);
  initMetadataForCompanion(Companion_11);
  initMetadataForClass(GridRowEnd, 'GridRowEnd', VOID, CssValue);
  initMetadataForCompanion(Companion_12);
  initMetadataForClass(GridRowStart, 'GridRowStart', VOID, CssValue);
  initMetadataForCompanion(Companion_13);
  initMetadataForClass(GridTemplate, 'GridTemplate', VOID, CssValue);
  initMetadataForCompanion(Companion_14);
  initMetadataForClass(GridTemplateAreas, 'GridTemplateAreas', VOID, CssValue);
  initMetadataForCompanion(Companion_15);
  initMetadataForClass(GridTemplateColumns, 'GridTemplateColumns', VOID, CssValue);
  initMetadataForCompanion(Companion_16);
  initMetadataForClass(GridTemplateRows, 'GridTemplateRows', VOID, CssValue);
  initMetadataForClass(Hyphens, 'Hyphens', VOID, Enum);
  initMetadataForClass(Isolation, 'Isolation', VOID, Enum);
  ...
  initMetadataForClass(ObjectFit, 'ObjectFit', VOID, Enum);
  initMetadataForCompanion(Companion_17);
  initMetadataForClass(Order, 'Order', VOID, CssValue);
  initMetadataForClass(Outline, 'Outline', VOID, Enum);
  ...
  initMetadataForClass(OverscrollBehavior, 'OverscrollBehavior', VOID, Enum);
  initMetadataForClass(PointerEvents, 'PointerEvents', VOID, Enum);
  initMetadataForClass(Position, 'Position', VOID, Enum);
  initMetadataForClass(Resize, 'Resize', VOID, Enum);
  initMetadataForClass(ScrollBehavior, 'ScrollBehavior', VOID, Enum);
  initMetadataForClass(TableLayout, 'TableLayout', VOID, Enum);
  ...
  initMetadataForClass(UserSelect, 'UserSelect', VOID, Enum);
  initMetadataForCompanion(Companion_18);
  initMetadataForClass(VerticalAlign, 'VerticalAlign', VOID, CssValue);
  initMetadataForClass(WhiteSpace, 'WhiteSpace', VOID, Enum);
  initMetadataForClass(WordBreak, 'WordBreak', VOID, Enum);
  initMetadataForClass(WordWrap, 'WordWrap', VOID, Enum);
  initMetadataForClass(StyleList, 'StyleList');
  function put(key, value) {
    this.get_declarations_u0xo5e_k$().set_xfbcfe_k$(key, value);
  }
  initMetadataForInterface(StyledElement, 'StyledElement');
  initMetadataForClass(CssProperty, 'CssProperty', CssProperty);
  initMetadataForClass(CssDeclarations, 'CssDeclarations', CssDeclarations, VOID, [KtMutableMap]);
  initMetadataForClass(TagSelector, 'TagSelector');
  initMetadataForObject(TagSelectorFactory, 'TagSelectorFactory');
  initMetadataForCompanion(Companion_19);
  initMetadataForClass(Animations, 'Animations', Animations, StyleList);
  initMetadataForClass(AnimationDirection, 'AnimationDirection', VOID, Enum);
  initMetadataForClass(FillMode, 'FillMode', VOID, Enum);
  initMetadataForClass(PlayState, 'PlayState', VOID, Enum);
  initMetadataForClass(Animation, 'Animation');
  initMetadataForCompanion(Companion_20);
  initMetadataForClass(IterationCount, 'IterationCount', VOID, CssValue);
  initMetadataForCompanion(Companion_21);
  initMetadataForClass(AspectRatio, 'AspectRatio', VOID, CssValue);
  initMetadataForCompanion(Companion_22);
  initMetadataForClass(BoxShadows, 'BoxShadows', BoxShadows, StyleList);
  initMetadataForClass(BoxShadow, 'BoxShadow');
  initMetadataForCompanion(Companion_23);
  initMetadataForClass(LineHeight, 'LineHeight', VOID, CssValue);
  ...
  initMetadataForClass(Time, 'Time', VOID, CssValue);
  initMetadataForCompanion(Companion_25);
  initMetadataForClass(Timing, 'Timing', VOID, CssValue);
  initMetadataForCompanion(Companion_26);
  initMetadataForClass(Transforms, 'Transforms', Transforms, StyleList);
  initMetadataForClass(Transform, 'Transform');
  initMetadataForCompanion(Companion_27);
  initMetadataForClass(Transitions, 'Transitions', Transitions, StyleList);
  ...
  function hyphenize(_this__u8e3s4) {
    _init_properties_Extensions_kt__653eno();
    var tmp1 = get_CAPITAL_LETTER();
    // Inline function 'kotlin.text.replace' call
    var transform = hyphenize$lambda;
    return tmp1.replace_dbivij_k$(_this__u8e3s4, transform);
  }
  ...
  function hyphenize$lambda(it) {
    ...
    return '-' + it.get_value_j01efc_k$().toLowerCase();
  }
  ...
  protoOf(LinearDimension).unaryMinus_6uz0qp_k$ = function () {
    ...
    if (startsWith_0(this.get_value_j01efc_k$(), _Char___init__impl__6a9atx(45))) {
      ...
      // Inline function 'kotlin.js.asDynamic' call
      tmp = this.get_value_j01efc_k$().substring(1);
  ...
  protoOf(LinearDimension).plus_mwb726_k$ = function (other) {
    return new LinearDimension('calc(' + _get_valueCalcSafe__v9ghsu(this) + ' + ' + _get_valueCalcSafe__v9ghsu(other) + ')');
  };
  protoOf(LinearDimension).minus_4mmoig_k$ = function (other) {
    return new LinearDimension('calc(' + _get_valueCalcSafe__v9ghsu(this) + ' - ' + _get_valueCalcSafe__v9ghsu(other) + ')');
  };
  protoOf(LinearDimension).times_8e3vaz_k$ = function (times) {
    return new LinearDimension('calc(' + _get_valueCalcSafe__v9ghsu(this) + ' * ' + toString(times) + ')');
  };
  protoOf(LinearDimension).div_5vv1sq_k$ = function (times) {
    return new LinearDimension('calc(' + _get_valueCalcSafe__v9ghsu(this) + ' / ' + toString(times) + ')');
  };
  ...
  function asRGBA$hueToRGB(m1, m2, h) {
    ...
    return hu < 1.0 / 6 ? m1 + (m2 - m1) * 6 * hu : hu < 1.0 / 2 ? m2 : hu < 2.0 / 3 ? m1 + (m2 - m1) * 6 * (2.0 / 3 - hu) : m1;
  }
  ...
  protoOf(Companion_0).normalizeFractionalPercent_8s52xn_k$ = function (value) {
    return coerceIn(value, 0.0, 1.0);
  };
  protoOf(Companion_0).normalizePercent_lozj8g_k$ = function (value) {
    return coerceIn_0(value, 0, 100);
  };
  protoOf(Companion_0).normalizeRGB_kt1hp4_k$ = function (value) {
    return coerceIn_0(value, 0, 255);
  };
  protoOf(Companion_0).normalizeHue_kn339h_k$ = function (value) {
    return roundToInt((value % 360 + 360) % 360);
  };
  protoOf(Companion_0).normalizeAlpha_qgc1qt_k$ = function (value) {
    return this.normalizeFractionalPercent_8s52xn_k$(value);
  };
  ...
  protoOf(RGBA).asHSLA_nb6n0u_k$ = function () {
    ...
    var lg = Companion_getInstance_0().normalizeFractionalPercent_8s52xn_k$((cMax + cMin) / 2);
    var tmp;
    if (!(chroma === 0.0)) {
      var tmp_0 = Companion_getInstance_0();
      // Inline function 'kotlin.math.abs' call
      var x = 2.0 * lg - 1.0;
      var tmp$ret$2 = Math.abs(x);
      tmp = tmp_0.normalizeFractionalPercent_8s52xn_k$(chroma / (1.0 - tmp$ret$2));
    } else {
      tmp = 0.0;
    }
    var s = tmp;
    ...
    if (cMax === cMin) {
      ...
      var message = 'Unexpected value for max';
      throw IllegalStateException_init_$Create$(toString(message));
    }
    var h = tmp_1;
    return new HSLA(Companion_getInstance_0().normalizeHue_kn339h_k$(h), roundToInt(s * 100), roundToInt(lg * 100), this.alpha_1);
  };
  ...
  protoOf(RGBA).copy_8vwb4z_k$ = function (red, green, blue, alpha) {
    return new RGBA(red, green, blue, alpha);
  };
  protoOf(RGBA).copy$default_ewocna_k$ = function (red, green, blue, alpha, $super) {
    ...
    return $super === VOID ? this.copy_8vwb4z_k$(red, green, blue, alpha) : $super.copy_8vwb4z_k$.call(this, red, green, blue, alpha);
  };
  ...
  protoOf(HSLA).asRGBA_nb0iai_k$ = function () {
    ...
    var m1 = 2 * lg - m2;
    var r = Companion_getInstance_0().normalizeFractionalPercent_8s52xn_k$(asRGBA$hueToRGB(m1, m2, h + 1.0 / 3));
    var g = Companion_getInstance_0().normalizeFractionalPercent_8s52xn_k$(asRGBA$hueToRGB(m1, m2, h));
    var b = Companion_getInstance_0().normalizeFractionalPercent_8s52xn_k$(asRGBA$hueToRGB(m1, m2, h - 1.0 / 3));
  ...
  protoOf(HSLA).copy_8vwb4z_k$ = function (hue, saturation, lightness, alpha) {
    return new HSLA(hue, saturation, lightness, alpha);
  };
  protoOf(HSLA).copy$default_usjdea_k$ = function (hue, saturation, lightness, alpha, $super) {
    ...
    alpha = alpha === VOID ? this.alpha_1 : alpha;
    return $super === VOID ? this.copy_8vwb4z_k$(hue, saturation, lightness, alpha) : $super.copy_8vwb4z_k$.call(this, hue, saturation, lightness, alpha);
  };
  ...
  function fromHSLANotation$getHSLParameter(match, this$0, index) {
    var tmp1_safe_receiver = match == null ? null : match.get_groups_dy12vx_k$();
    var tmp2_safe_receiver = tmp1_safe_receiver == null ? null : tmp1_safe_receiver.get_c1px32_k$(index);
  ...
  function fromRGBANotation$getRGBParameter(match, this$0, index) {
    ...
    var group = tmp;
    return endsWith(group, _Char___init__impl__6a9atx(37)) ? numberToInt(Companion_getInstance_0().normalizeFractionalPercent_8s52xn_k$(toDouble(substringBefore(group, _Char___init__impl__6a9atx(37))) / 100.0) * 255.0) : Companion_getInstance_0().normalizeRGB_kt1hp4_k$(toInt(group));
  }
  ...
  protoOf(Color).withAlpha_9ns242_k$ = function (alpha) {
    var tmp;
    if (startsWith(this.value_2, 'hsl', true)) {
      // Inline function 'kotlin.with' call
      var $this$with = this.fromHSLANotation_so5m72_k$();
      tmp = hsla($this$with.hue_1, $this$with.saturation_1, $this$with.lightness_1, Companion_getInstance_0().normalizeAlpha_qgc1qt_k$(alpha) * $this$with.alpha_1);
    } else {
      // Inline function 'kotlin.with' call
      var $this$with_0 = this.toRGBA_ulv3en_k$();
      tmp = rgba($this$with_0.red_1, $this$with_0.green_1, $this$with_0.blue_1, Companion_getInstance_0().normalizeAlpha_qgc1qt_k$(alpha) * $this$with_0.alpha_1);
    }
    return tmp;
  };
  protoOf(Color).changeAlpha_b0pi6g_k$ = function (alpha) {
    var tmp;
    if (startsWith(this.value_2, 'hsl', true)) {
      // Inline function 'kotlin.with' call
      var $this$with = this.fromHSLANotation_so5m72_k$();
      tmp = hsla($this$with.hue_1, $this$with.saturation_1, $this$with.lightness_1, Companion_getInstance_0().normalizeAlpha_qgc1qt_k$(alpha));
    } else {
      // Inline function 'kotlin.with' call
      var $this$with_0 = this.toRGBA_ulv3en_k$();
      tmp = rgba($this$with_0.red_1, $this$with_0.green_1, $this$with_0.blue_1, Companion_getInstance_0().normalizeAlpha_qgc1qt_k$(alpha));
    }
    return tmp;
  };
  protoOf(Color).blend_lux96t_k$ = function (backgroundColor) {
    var source = this.toRGBA_ulv3en_k$();
    var background = backgroundColor.toRGBA_ulv3en_k$();
  ...
  protoOf(Color).lighten_d4lu7t_k$ = function (percent) {
    var isHSLA = startsWith(this.value_2, 'hsl', true);
    var hsla_0 = isHSLA ? this.fromHSLANotation_so5m72_k$() : this.toRGBA_ulv3en_k$().asHSLA_nb6n0u_k$();
    var lightness = hsla_0.lightness_1 + roundToInt(hsla_0.lightness_1 * (Companion_getInstance_0().normalizePercent_lozj8g_k$(percent) / 100.0)) | 0;
    var newHSLa = hsla_0.copy$default_usjdea_k$(VOID, VOID, Companion_getInstance_0().normalizePercent_lozj8g_k$(lightness));
    var tmp;
    if (isHSLA) {
      tmp = hsla(newHSLa.hue_1, newHSLa.saturation_1, newHSLa.lightness_1, newHSLa.alpha_1);
    } else {
      // Inline function 'kotlin.with' call
      var $this$with = newHSLa.asRGBA_nb0iai_k$();
      tmp = rgba($this$with.red_1, $this$with.green_1, $this$with.blue_1, $this$with.alpha_1);
    }
    return tmp;
  };
  protoOf(Color).darken_v96vjb_k$ = function (percent) {
    var isHSLA = startsWith(this.value_2, 'hsl', true);
    var hsla_0 = isHSLA ? this.fromHSLANotation_so5m72_k$() : this.toRGBA_ulv3en_k$().asHSLA_nb6n0u_k$();
    var darkness = hsla_0.lightness_1 - roundToInt(hsla_0.lightness_1 * (Companion_getInstance_0().normalizePercent_lozj8g_k$(percent) / 100.0)) | 0;
    var newHSLa = hsla_0.copy$default_usjdea_k$(VOID, VOID, Companion_getInstance_0().normalizePercent_lozj8g_k$(darkness));
    var tmp;
    if (isHSLA) {
      tmp = hsla(newHSLa.hue_1, newHSLa.saturation_1, newHSLa.lightness_1, newHSLa.alpha_1);
    } else {
  ...
  protoOf(Color).saturate_5ng113_k$ = function (percent) {
    var isHSLA = startsWith(this.value_2, 'hsl', true);
    var hsla_0 = isHSLA ? this.fromHSLANotation_so5m72_k$() : this.toRGBA_ulv3en_k$().asHSLA_nb6n0u_k$();
    var saturation = hsla_0.saturation_1 + roundToInt(hsla_0.saturation_1 * (Companion_getInstance_0().normalizePercent_lozj8g_k$(percent) / 100.0)) | 0;
    var newHSLa = hsla_0.copy$default_usjdea_k$(VOID, Companion_getInstance_0().normalizePercent_lozj8g_k$(saturation));
    var tmp;
    if (isHSLA) {
      tmp = hsla(newHSLa.hue_1, newHSLa.saturation_1, newHSLa.lightness_1, newHSLa.alpha_1);
    } else {
  ...
  protoOf(Color).desaturate_aqkgmg_k$ = function (percent) {
    var isHSLA = startsWith(this.value_2, 'hsl', true);
    var hsla_0 = isHSLA ? this.fromHSLANotation_so5m72_k$() : this.toRGBA_ulv3en_k$().asHSLA_nb6n0u_k$();
    var desaturation = hsla_0.saturation_1 - roundToInt(hsla_0.saturation_1 * (Companion_getInstance_0().normalizePercent_lozj8g_k$(percent) / 100.0)) | 0;
    var newHSLa = hsla_0.copy$default_usjdea_k$(VOID, Companion_getInstance_0().normalizePercent_lozj8g_k$(desaturation));
    var tmp;
    if (isHSLA) {
      tmp = hsla(newHSLa.hue_1, newHSLa.saturation_1, newHSLa.lightness_1, newHSLa.alpha_1);
    } else {
  ...
  protoOf(Color).fromHSLANotation_so5m72_k$ = function () {
    var match = _get_HSLA_REGEX__fy6jkz(Companion_getInstance_0()).find$default_xakyli_k$(this.value_2);
    var hueShape = fromHSLANotation$getHSLParameter(match, this, 1);
    var hue = Companion_getInstance_0().normalizeHue_kn339h_k$(endsWith_0(hueShape, 'grad', true) ? toDouble(substringBefore_0(hueShape, 'grad')) * (9.0 / 10) : endsWith_0(hueShape, 'rad', true) ? toDouble(substringBefore_0(hueShape, 'rad')) * 180 / get_PI() : endsWith_0(hueShape, 'turn', true) ? toDouble(substringBefore_0(hueShape, 'turn')) * 360.0 : endsWith_0(hueShape, 'deg', true) ? toDouble(substringBefore_0(hueShape, 'deg')) : toDouble(hueShape));
    var saturation = Companion_getInstance_0().normalizePercent_lozj8g_k$(toInt(fromHSLANotation$getHSLParameter(match, this, 2)));
    var lightness = Companion_getInstance_0().normalizePercent_lozj8g_k$(toInt(fromHSLANotation$getHSLParameter(match, this, 3)));
    var tmp = Companion_getInstance_0();
    var tmp1_safe_receiver = match == null ? null : match.get_groups_dy12vx_k$();
    var tmp2_safe_receiver = tmp1_safe_receiver == null ? null : tmp1_safe_receiver.get_c1px32_k$(4);
    ...
    var alpha = tmp.normalizeAlpha_qgc1qt_k$(tmp4_elvis_lhs == null ? 1.0 : tmp4_elvis_lhs);
    return new HSLA(hue, saturation, lightness, alpha);
  };
  protoOf(Color).fromRGBANotation_7319n6_k$ = function () {
    var match = _get_RGBA_REGEX__eceqfl(Companion_getInstance_0()).find$default_xakyli_k$(this.value_2);
  ...
  protoOf(Color).toRGBA_ulv3en_k$ = function () {
    ...
    } else if (startsWith(v, '#') && (v.length === 7 || v.length === 9)) {
  ...
  protoOf(Companion_4).fitContent_md1mtl_k$ = function (argument) {
    return new GridAutoColumns('minmax(auto, max(auto, ' + argument.toString() + '))');
  };
  protoOf(Companion_4).minMax_ywzyz2_k$ = function (min, max) {
    return new GridAutoColumns('minmax(' + min.toString() + ', ' + max.toString() + ')');
  };
  protoOf(Companion_4).minMax_hhtfvy_k$ = function (min, max) {
    return new GridAutoColumns('minmax(' + min.toString() + ', ' + max.toString() + ')');
  };
  ...
  protoOf(Companion_6).fitContent_r8akh9_k$ = function (argument) {
    return new GridAutoRows('minmax(auto, max(auto, ' + argument.toString() + '))');
  };
  protoOf(Companion_6).minMax_ywzyz2_k$ = function (min, max) {
    return new GridAutoRows('minmax(' + min.toString() + ', ' + max.toString() + ')');
  };
  protoOf(Companion_6).minMax_a3wtfg_k$ = function (min, max) {
    return new GridAutoRows('minmax(' + min.toString() + ', ' + max.toString() + ')');
  };
  ...
  protoOf(Companion_15).fitContent_mefagg_k$ = function (dim) {
    return new GridTemplateColumns('min(max-content, max(auto, ' + dim.toString() + '))');
  };
  protoOf(Companion_15).minMax_ywzyz2_k$ = function (min, max) {
    return new GridTemplateColumns('minmax(' + min.toString() + ', ' + max.toString() + ')');
  };
  protoOf(Companion_15).minMax_fcgywi_k$ = function (min, max) {
    return new GridTemplateColumns('minmax(' + min.toString() + ', ' + max.toString() + ')');
  };
  protoOf(Companion_15).repeat_ljpk3j_k$ = function (argument) {
  ...
  protoOf(Companion_16).fitContent_mefagg_k$ = function (dim) {
    return new GridTemplateRows('min(max-content, max(auto, ' + dim.toString() + '))');
  };
  protoOf(Companion_16).minMax_ywzyz2_k$ = function (min, max) {
    return new GridTemplateRows('minmax(' + min.toString() + ', ' + max.toString() + ')');
  };
  protoOf(Companion_16).minMax_ccag6e_k$ = function (min, max) {
    return new GridTemplateRows('minmax(' + min.toString() + ', ' + max.toString() + ')');
  };
  protoOf(Companion_16).repeat_ljpk3j_k$ = function (argument) {
  ...
  protoOf(StyleList).clear_j9egeb_k$ = function () {
    return this.list_1.clear_j9egeb_k$();
  };
  protoOf(StyleList).plusAssign_xac6iy_k$ = function (item) {
    // Inline function 'kotlin.collections.plusAssign' call
    this.list_1.add_utx5q5_k$(item);
  };
  function set_alignContent(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return alignContent$delegate.setValue_a8togt_k$(_this__u8e3s4, alignContent$factory(), _set____db54di);
  }
  function get_alignContent(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return alignContent$delegate.getValue_98unww_k$(_this__u8e3s4, alignContent$factory_0());
  }
  var alignContent$delegate;
  function set_alignItems(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return alignItems$delegate.setValue_a8togt_k$(_this__u8e3s4, alignItems$factory(), _set____db54di);
  }
  function get_alignItems(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return alignItems$delegate.getValue_98unww_k$(_this__u8e3s4, alignItems$factory_0());
  }
  var alignItems$delegate;
  function set_alignSelf(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return alignSelf$delegate.setValue_a8togt_k$(_this__u8e3s4, alignSelf$factory(), _set____db54di);
  }
  function get_alignSelf(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return alignSelf$delegate.getValue_98unww_k$(_this__u8e3s4, alignSelf$factory_0());
  }
  var alignSelf$delegate;
  function set_animation(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return animation$delegate.setValue_a8togt_k$(_this__u8e3s4, animation$factory(), _set____db54di);
  }
  function get_animation(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return animation$delegate.getValue_98unww_k$(_this__u8e3s4, animation$factory_0());
  }
  var animation$delegate;
  function set_animationDelay(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return animationDelay$delegate.setValue_a8togt_k$(_this__u8e3s4, animationDelay$factory(), _set____db54di);
  }
  function get_animationDelay(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return animationDelay$delegate.getValue_98unww_k$(_this__u8e3s4, animationDelay$factory_0());
  }
  var animationDelay$delegate;
  function set_animationDirection(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return animationDirection$delegate.setValue_a8togt_k$(_this__u8e3s4, animationDirection$factory(), _set____db54di);
  }
  function get_animationDirection(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return animationDirection$delegate.getValue_98unww_k$(_this__u8e3s4, animationDirection$factory_0());
  }
  var animationDirection$delegate;
  function set_animationDuration(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return animationDuration$delegate.setValue_a8togt_k$(_this__u8e3s4, animationDuration$factory(), _set____db54di);
  }
  function get_animationDuration(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return animationDuration$delegate.getValue_98unww_k$(_this__u8e3s4, animationDuration$factory_0());
  }
  var animationDuration$delegate;
  function set_animationFillMode(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return animationFillMode$delegate.setValue_a8togt_k$(_this__u8e3s4, animationFillMode$factory(), _set____db54di);
  }
  function get_animationFillMode(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return animationFillMode$delegate.getValue_98unww_k$(_this__u8e3s4, animationFillMode$factory_0());
  }
  var animationFillMode$delegate;
  function set_animationIterationCount(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return animationIterationCount$delegate.setValue_a8togt_k$(_this__u8e3s4, animationIterationCount$factory(), _set____db54di);
  }
  function get_animationIterationCount(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return animationIterationCount$delegate.getValue_98unww_k$(_this__u8e3s4, animationIterationCount$factory_0());
  }
  var animationIterationCount$delegate;
  function set_animationName(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return animationName$delegate.setValue_a8togt_k$(_this__u8e3s4, animationName$factory(), _set____db54di);
  }
  function get_animationName(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return animationName$delegate.getValue_98unww_k$(_this__u8e3s4, animationName$factory_0());
  }
  var animationName$delegate;
  function set_animationPlayState(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return animationPlayState$delegate.setValue_a8togt_k$(_this__u8e3s4, animationPlayState$factory(), _set____db54di);
  }
  function get_animationPlayState(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return animationPlayState$delegate.getValue_98unww_k$(_this__u8e3s4, animationPlayState$factory_0());
  }
  var animationPlayState$delegate;
  function set_animationTimingFunction(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return animationTimingFunction$delegate.setValue_a8togt_k$(_this__u8e3s4, animationTimingFunction$factory(), _set____db54di);
  }
  function get_animationTimingFunction(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return animationTimingFunction$delegate.getValue_98unww_k$(_this__u8e3s4, animationTimingFunction$factory_0());
  }
  var animationTimingFunction$delegate;
  function set_appearance(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return appearance$delegate.setValue_a8togt_k$(_this__u8e3s4, appearance$factory(), _set____db54di);
  }
  function get_appearance(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return appearance$delegate.getValue_98unww_k$(_this__u8e3s4, appearance$factory_0());
  }
  var appearance$delegate;
  function set_aspectRatio(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return aspectRatio$delegate.setValue_a8togt_k$(_this__u8e3s4, aspectRatio$factory(), _set____db54di);
  }
  function get_aspectRatio(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return aspectRatio$delegate.getValue_98unww_k$(_this__u8e3s4, aspectRatio$factory_0());
  }
  var aspectRatio$delegate;
  function set_backfaceVisibility(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return backfaceVisibility$delegate.setValue_a8togt_k$(_this__u8e3s4, backfaceVisibility$factory(), _set____db54di);
  }
  function get_backfaceVisibility(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return backfaceVisibility$delegate.getValue_98unww_k$(_this__u8e3s4, backfaceVisibility$factory_0());
  }
  var backfaceVisibility$delegate;
  function set_background(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return background$delegate.setValue_a8togt_k$(_this__u8e3s4, background$factory(), _set____db54di);
  }
  function get_background(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return background$delegate.getValue_98unww_k$(_this__u8e3s4, background$factory_0());
  }
  var background$delegate;
  function set_backgroundAttachment(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return backgroundAttachment$delegate.setValue_a8togt_k$(_this__u8e3s4, backgroundAttachment$factory(), _set____db54di);
  }
  function get_backgroundAttachment(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return backgroundAttachment$delegate.getValue_98unww_k$(_this__u8e3s4, backgroundAttachment$factory_0());
  }
  var backgroundAttachment$delegate;
  function set_backgroundClip(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return backgroundClip$delegate.setValue_a8togt_k$(_this__u8e3s4, backgroundClip$factory(), _set____db54di);
  }
  function get_backgroundClip(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return backgroundClip$delegate.getValue_98unww_k$(_this__u8e3s4, backgroundClip$factory_0());
  }
  var backgroundClip$delegate;
  function set_backgroundColor(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return backgroundColor$delegate.setValue_a8togt_k$(_this__u8e3s4, backgroundColor$factory(), _set____db54di);
  }
  function get_backgroundColor(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return backgroundColor$delegate.getValue_98unww_k$(_this__u8e3s4, backgroundColor$factory_0());
  }
  var backgroundColor$delegate;
  function set_backgroundImage(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return backgroundImage$delegate.setValue_a8togt_k$(_this__u8e3s4, backgroundImage$factory(), _set____db54di);
  }
  function get_backgroundImage(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return backgroundImage$delegate.getValue_98unww_k$(_this__u8e3s4, backgroundImage$factory_0());
  }
  var backgroundImage$delegate;
  function set_backgroundOrigin(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return backgroundOrigin$delegate.setValue_a8togt_k$(_this__u8e3s4, backgroundOrigin$factory(), _set____db54di);
  }
  function get_backgroundOrigin(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return backgroundOrigin$delegate.getValue_98unww_k$(_this__u8e3s4, backgroundOrigin$factory_0());
  }
  var backgroundOrigin$delegate;
  function set_backgroundPosition(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return backgroundPosition$delegate.setValue_a8togt_k$(_this__u8e3s4, backgroundPosition$factory(), _set____db54di);
  }
  function get_backgroundPosition(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return backgroundPosition$delegate.getValue_98unww_k$(_this__u8e3s4, backgroundPosition$factory_0());
  }
  var backgroundPosition$delegate;
  function set_backgroundRepeat(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return backgroundRepeat$delegate.setValue_a8togt_k$(_this__u8e3s4, backgroundRepeat$factory(), _set____db54di);
  }
  function get_backgroundRepeat(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return backgroundRepeat$delegate.getValue_98unww_k$(_this__u8e3s4, backgroundRepeat$factory_0());
  }
  var backgroundRepeat$delegate;
  function set_backgroundSize(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return backgroundSize$delegate.setValue_a8togt_k$(_this__u8e3s4, backgroundSize$factory(), _set____db54di);
  }
  function get_backgroundSize(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return backgroundSize$delegate.getValue_98unww_k$(_this__u8e3s4, backgroundSize$factory_0());
  }
  var backgroundSize$delegate;
  function set_border(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return border$delegate.setValue_a8togt_k$(_this__u8e3s4, border$factory(), _set____db54di);
  }
  function get_border(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return border$delegate.getValue_98unww_k$(_this__u8e3s4, border$factory_0());
  }
  var border$delegate;
  function set_borderTop(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderTop$delegate.setValue_a8togt_k$(_this__u8e3s4, borderTop$factory(), _set____db54di);
  }
  function get_borderTop(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderTop$delegate.getValue_98unww_k$(_this__u8e3s4, borderTop$factory_0());
  }
  var borderTop$delegate;
  function set_borderRight(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderRight$delegate.setValue_a8togt_k$(_this__u8e3s4, borderRight$factory(), _set____db54di);
  }
  function get_borderRight(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderRight$delegate.getValue_98unww_k$(_this__u8e3s4, borderRight$factory_0());
  }
  var borderRight$delegate;
  function set_borderBottom(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderBottom$delegate.setValue_a8togt_k$(_this__u8e3s4, borderBottom$factory(), _set____db54di);
  }
  function get_borderBottom(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderBottom$delegate.getValue_98unww_k$(_this__u8e3s4, borderBottom$factory_0());
  }
  var borderBottom$delegate;
  function set_borderLeft(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderLeft$delegate.setValue_a8togt_k$(_this__u8e3s4, borderLeft$factory(), _set____db54di);
  }
  function get_borderLeft(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderLeft$delegate.getValue_98unww_k$(_this__u8e3s4, borderLeft$factory_0());
  }
  var borderLeft$delegate;
  function set_borderCollapse(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderCollapse$delegate.setValue_a8togt_k$(_this__u8e3s4, borderCollapse$factory(), _set____db54di);
  }
  function get_borderCollapse(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderCollapse$delegate.getValue_98unww_k$(_this__u8e3s4, borderCollapse$factory_0());
  }
  var borderCollapse$delegate;
  function set_borderSpacing(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderSpacing$delegate.setValue_a8togt_k$(_this__u8e3s4, borderSpacing$factory(), _set____db54di);
  }
  function get_borderSpacing(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderSpacing$delegate.getValue_98unww_k$(_this__u8e3s4, borderSpacing$factory_0());
  }
  var borderSpacing$delegate;
  function set_borderRadius(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderRadius$delegate.setValue_a8togt_k$(_this__u8e3s4, borderRadius$factory(), _set____db54di);
  }
  function get_borderRadius(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderRadius$delegate.getValue_98unww_k$(_this__u8e3s4, borderRadius$factory_0());
  }
  var borderRadius$delegate;
  function set_borderTopLeftRadius(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderTopLeftRadius$delegate.setValue_a8togt_k$(_this__u8e3s4, borderTopLeftRadius$factory(), _set____db54di);
  }
  function get_borderTopLeftRadius(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderTopLeftRadius$delegate.getValue_98unww_k$(_this__u8e3s4, borderTopLeftRadius$factory_0());
  }
  var borderTopLeftRadius$delegate;
  function set_borderTopRightRadius(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderTopRightRadius$delegate.setValue_a8togt_k$(_this__u8e3s4, borderTopRightRadius$factory(), _set____db54di);
  }
  function get_borderTopRightRadius(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderTopRightRadius$delegate.getValue_98unww_k$(_this__u8e3s4, borderTopRightRadius$factory_0());
  }
  var borderTopRightRadius$delegate;
  function set_borderBottomLeftRadius(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderBottomLeftRadius$delegate.setValue_a8togt_k$(_this__u8e3s4, borderBottomLeftRadius$factory(), _set____db54di);
  }
  function get_borderBottomLeftRadius(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderBottomLeftRadius$delegate.getValue_98unww_k$(_this__u8e3s4, borderBottomLeftRadius$factory_0());
  }
  var borderBottomLeftRadius$delegate;
  function set_borderBottomRightRadius(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderBottomRightRadius$delegate.setValue_a8togt_k$(_this__u8e3s4, borderBottomRightRadius$factory(), _set____db54di);
  }
  function get_borderBottomRightRadius(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderBottomRightRadius$delegate.getValue_98unww_k$(_this__u8e3s4, borderBottomRightRadius$factory_0());
  }
  var borderBottomRightRadius$delegate;
  function set_borderStyle(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderStyle$delegate.setValue_a8togt_k$(_this__u8e3s4, borderStyle$factory(), _set____db54di);
  }
  function get_borderStyle(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderStyle$delegate.getValue_98unww_k$(_this__u8e3s4, borderStyle$factory_0());
  }
  var borderStyle$delegate;
  function set_borderTopStyle(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderTopStyle$delegate.setValue_a8togt_k$(_this__u8e3s4, borderTopStyle$factory(), _set____db54di);
  }
  function get_borderTopStyle(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderTopStyle$delegate.getValue_98unww_k$(_this__u8e3s4, borderTopStyle$factory_0());
  }
  var borderTopStyle$delegate;
  function set_borderRightStyle(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderRightStyle$delegate.setValue_a8togt_k$(_this__u8e3s4, borderRightStyle$factory(), _set____db54di);
  }
  function get_borderRightStyle(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderRightStyle$delegate.getValue_98unww_k$(_this__u8e3s4, borderRightStyle$factory_0());
  }
  var borderRightStyle$delegate;
  function set_borderBottomStyle(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderBottomStyle$delegate.setValue_a8togt_k$(_this__u8e3s4, borderBottomStyle$factory(), _set____db54di);
  }
  function get_borderBottomStyle(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderBottomStyle$delegate.getValue_98unww_k$(_this__u8e3s4, borderBottomStyle$factory_0());
  }
  var borderBottomStyle$delegate;
  function set_borderLeftStyle(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderLeftStyle$delegate.setValue_a8togt_k$(_this__u8e3s4, borderLeftStyle$factory(), _set____db54di);
  }
  function get_borderLeftStyle(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderLeftStyle$delegate.getValue_98unww_k$(_this__u8e3s4, borderLeftStyle$factory_0());
  }
  var borderLeftStyle$delegate;
  function set_borderWidth(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderWidth$delegate.setValue_a8togt_k$(_this__u8e3s4, borderWidth$factory(), _set____db54di);
  }
  function get_borderWidth(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderWidth$delegate.getValue_98unww_k$(_this__u8e3s4, borderWidth$factory_0());
  }
  var borderWidth$delegate;
  function set_borderTopWidth(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderTopWidth$delegate.setValue_a8togt_k$(_this__u8e3s4, borderTopWidth$factory(), _set____db54di);
  }
  function get_borderTopWidth(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderTopWidth$delegate.getValue_98unww_k$(_this__u8e3s4, borderTopWidth$factory_0());
  }
  var borderTopWidth$delegate;
  function set_borderRightWidth(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderRightWidth$delegate.setValue_a8togt_k$(_this__u8e3s4, borderRightWidth$factory(), _set____db54di);
  }
  function get_borderRightWidth(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderRightWidth$delegate.getValue_98unww_k$(_this__u8e3s4, borderRightWidth$factory_0());
  }
  var borderRightWidth$delegate;
  function set_borderBottomWidth(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderBottomWidth$delegate.setValue_a8togt_k$(_this__u8e3s4, borderBottomWidth$factory(), _set____db54di);
  }
  function get_borderBottomWidth(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderBottomWidth$delegate.getValue_98unww_k$(_this__u8e3s4, borderBottomWidth$factory_0());
  }
  var borderBottomWidth$delegate;
  function set_borderLeftWidth(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderLeftWidth$delegate.setValue_a8togt_k$(_this__u8e3s4, borderLeftWidth$factory(), _set____db54di);
  }
  function get_borderLeftWidth(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderLeftWidth$delegate.getValue_98unww_k$(_this__u8e3s4, borderLeftWidth$factory_0());
  }
  var borderLeftWidth$delegate;
  function set_borderColor(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderColor$delegate.setValue_a8togt_k$(_this__u8e3s4, borderColor$factory(), _set____db54di);
  }
  function get_borderColor(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderColor$delegate.getValue_98unww_k$(_this__u8e3s4, borderColor$factory_0());
  }
  var borderColor$delegate;
  function set_borderTopColor(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderTopColor$delegate.setValue_a8togt_k$(_this__u8e3s4, borderTopColor$factory(), _set____db54di);
  }
  function get_borderTopColor(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderTopColor$delegate.getValue_98unww_k$(_this__u8e3s4, borderTopColor$factory_0());
  }
  var borderTopColor$delegate;
  function set_borderRightColor(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderRightColor$delegate.setValue_a8togt_k$(_this__u8e3s4, borderRightColor$factory(), _set____db54di);
  }
  function get_borderRightColor(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderRightColor$delegate.getValue_98unww_k$(_this__u8e3s4, borderRightColor$factory_0());
  }
  var borderRightColor$delegate;
  function set_borderBottomColor(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderBottomColor$delegate.setValue_a8togt_k$(_this__u8e3s4, borderBottomColor$factory(), _set____db54di);
  }
  function get_borderBottomColor(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderBottomColor$delegate.getValue_98unww_k$(_this__u8e3s4, borderBottomColor$factory_0());
  }
  var borderBottomColor$delegate;
  function set_borderLeftColor(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderLeftColor$delegate.setValue_a8togt_k$(_this__u8e3s4, borderLeftColor$factory(), _set____db54di);
  }
  function get_borderLeftColor(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return borderLeftColor$delegate.getValue_98unww_k$(_this__u8e3s4, borderLeftColor$factory_0());
  }
  var borderLeftColor$delegate;
  function set_bottom(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return bottom$delegate.setValue_a8togt_k$(_this__u8e3s4, bottom$factory(), _set____db54di);
  }
  function get_bottom(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return bottom$delegate.getValue_98unww_k$(_this__u8e3s4, bottom$factory_0());
  }
  var bottom$delegate;
  function set_boxShadow(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return boxShadow$delegate.setValue_a8togt_k$(_this__u8e3s4, boxShadow$factory(), _set____db54di);
  }
  function get_boxShadow(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return boxShadow$delegate.getValue_98unww_k$(_this__u8e3s4, boxShadow$factory_0());
  }
  var boxShadow$delegate;
  function set_boxSizing(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return boxSizing$delegate.setValue_a8togt_k$(_this__u8e3s4, boxSizing$factory(), _set____db54di);
  }
  function get_boxSizing(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return boxSizing$delegate.getValue_98unww_k$(_this__u8e3s4, boxSizing$factory_0());
  }
  var boxSizing$delegate;
  function set_clear(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return clear$delegate.setValue_a8togt_k$(_this__u8e3s4, clear$factory(), _set____db54di);
  }
  function get_clear(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return clear$delegate.getValue_98unww_k$(_this__u8e3s4, clear$factory_0());
  }
  var clear$delegate;
  function set_color(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return color$delegate.setValue_a8togt_k$(_this__u8e3s4, color$factory(), _set____db54di);
  }
  function get_color(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return color$delegate.getValue_98unww_k$(_this__u8e3s4, color$factory_0());
  }
  var color$delegate;
  function set_columnGap(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return columnGap$delegate.setValue_a8togt_k$(_this__u8e3s4, columnGap$factory(), _set____db54di);
  }
  function get_columnGap(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return columnGap$delegate.getValue_98unww_k$(_this__u8e3s4, columnGap$factory_0());
  }
  var columnGap$delegate;
  function set_contain(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return contain$delegate.setValue_a8togt_k$(_this__u8e3s4, contain$factory(), _set____db54di);
  }
  function get_contain(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return contain$delegate.getValue_98unww_k$(_this__u8e3s4, contain$factory_0());
  }
  var contain$delegate;
  function set_content(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return content$delegate.setValue_a8togt_k$(_this__u8e3s4, content$factory(), _set____db54di);
  }
  function get_content(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return content$delegate.getValue_98unww_k$(_this__u8e3s4, content$factory_0());
  }
  var content$delegate;
  function set_cursor(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return cursor$delegate.setValue_a8togt_k$(_this__u8e3s4, cursor$factory(), _set____db54di);
  }
  function get_cursor(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return cursor$delegate.getValue_98unww_k$(_this__u8e3s4, cursor$factory_0());
  }
  var cursor$delegate;
  function set_direction(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return direction$delegate.setValue_a8togt_k$(_this__u8e3s4, direction$factory(), _set____db54di);
  }
  function get_direction(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return direction$delegate.getValue_98unww_k$(_this__u8e3s4, direction$factory_0());
  }
  var direction$delegate;
  function set_display(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return display$delegate.setValue_a8togt_k$(_this__u8e3s4, display$factory(), _set____db54di);
  }
  function get_display(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return display$delegate.getValue_98unww_k$(_this__u8e3s4, display$factory_0());
  }
  var display$delegate;
  function set_filter(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return filter$delegate.setValue_a8togt_k$(_this__u8e3s4, filter$factory(), _set____db54di);
  }
  function get_filter(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return filter$delegate.getValue_98unww_k$(_this__u8e3s4, filter$factory_0());
  }
  var filter$delegate;
  function set_flexBasis(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return flexBasis$delegate.setValue_a8togt_k$(_this__u8e3s4, flexBasis$factory(), _set____db54di);
  }
  function get_flexBasis(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return flexBasis$delegate.getValue_98unww_k$(_this__u8e3s4, flexBasis$factory_0());
  }
  var flexBasis$delegate;
  function set_flexDirection(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return flexDirection$delegate.setValue_a8togt_k$(_this__u8e3s4, flexDirection$factory(), _set____db54di);
  }
  function get_flexDirection(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return flexDirection$delegate.getValue_98unww_k$(_this__u8e3s4, flexDirection$factory_0());
  }
  var flexDirection$delegate;
  function set_flexGrow(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return flexGrow$delegate.setValue_a8togt_k$(_this__u8e3s4, flexGrow$factory(), _set____db54di);
  }
  function get_flexGrow(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return flexGrow$delegate.getValue_98unww_k$(_this__u8e3s4, flexGrow$factory_0());
  }
  var flexGrow$delegate;
  function set_flexShrink(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return flexShrink$delegate.setValue_a8togt_k$(_this__u8e3s4, flexShrink$factory(), _set____db54di);
  }
  function get_flexShrink(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return flexShrink$delegate.getValue_98unww_k$(_this__u8e3s4, flexShrink$factory_0());
  }
  var flexShrink$delegate;
  function set_flexWrap(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return flexWrap$delegate.setValue_a8togt_k$(_this__u8e3s4, flexWrap$factory(), _set____db54di);
  }
  function get_flexWrap(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return flexWrap$delegate.getValue_98unww_k$(_this__u8e3s4, flexWrap$factory_0());
  }
  var flexWrap$delegate;
  function set_float(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return float$delegate.setValue_a8togt_k$(_this__u8e3s4, float$factory(), _set____db54di);
  }
  function get_float(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return float$delegate.getValue_98unww_k$(_this__u8e3s4, float$factory_0());
  }
  var float$delegate;
  function set_fontFamily(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return fontFamily$delegate.setValue_a8togt_k$(_this__u8e3s4, fontFamily$factory(), _set____db54di);
  }
  function get_fontFamily(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return fontFamily$delegate.getValue_98unww_k$(_this__u8e3s4, fontFamily$factory_0());
  }
  var fontFamily$delegate;
  function set_fontSize(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return fontSize$delegate.setValue_a8togt_k$(_this__u8e3s4, fontSize$factory(), _set____db54di);
  }
  function get_fontSize(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return fontSize$delegate.getValue_98unww_k$(_this__u8e3s4, fontSize$factory_0());
  }
  var fontSize$delegate;
  function set_fontSizeAdjust(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return fontSizeAdjust$delegate.setValue_a8togt_k$(_this__u8e3s4, fontSizeAdjust$factory(), _set____db54di);
  }
  function get_fontSizeAdjust(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return fontSizeAdjust$delegate.getValue_98unww_k$(_this__u8e3s4, fontSizeAdjust$factory_0());
  }
  var fontSizeAdjust$delegate;
  function set_fontStyle(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return fontStyle$delegate.setValue_a8togt_k$(_this__u8e3s4, fontStyle$factory(), _set____db54di);
  }
  function get_fontStyle(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return fontStyle$delegate.getValue_98unww_k$(_this__u8e3s4, fontStyle$factory_0());
  }
  var fontStyle$delegate;
  function set_fontWeight(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return fontWeight$delegate.setValue_a8togt_k$(_this__u8e3s4, fontWeight$factory(), _set____db54di);
  }
  function get_fontWeight(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return fontWeight$delegate.getValue_98unww_k$(_this__u8e3s4, fontWeight$factory_0());
  }
  var fontWeight$delegate;
  function set_gap(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gap$delegate.setValue_a8togt_k$(_this__u8e3s4, gap$factory(), _set____db54di);
  }
  function get_gap(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gap$delegate.getValue_98unww_k$(_this__u8e3s4, gap$factory_0());
  }
  var gap$delegate;
  function set_gridAutoColumns(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridAutoColumns$delegate.setValue_a8togt_k$(_this__u8e3s4, gridAutoColumns$factory(), _set____db54di);
  }
  function get_gridAutoColumns(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridAutoColumns$delegate.getValue_98unww_k$(_this__u8e3s4, gridAutoColumns$factory_0());
  }
  var gridAutoColumns$delegate;
  function set_gridAutoFlow(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridAutoFlow$delegate.setValue_a8togt_k$(_this__u8e3s4, gridAutoFlow$factory(), _set____db54di);
  }
  function get_gridAutoFlow(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridAutoFlow$delegate.getValue_98unww_k$(_this__u8e3s4, gridAutoFlow$factory_0());
  }
  var gridAutoFlow$delegate;
  function set_gridAutoRows(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridAutoRows$delegate.setValue_a8togt_k$(_this__u8e3s4, gridAutoRows$factory(), _set____db54di);
  }
  function get_gridAutoRows(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridAutoRows$delegate.getValue_98unww_k$(_this__u8e3s4, gridAutoRows$factory_0());
  }
  var gridAutoRows$delegate;
  function set_gridColumn(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridColumn$delegate.setValue_a8togt_k$(_this__u8e3s4, gridColumn$factory(), _set____db54di);
  }
  function get_gridColumn(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridColumn$delegate.getValue_98unww_k$(_this__u8e3s4, gridColumn$factory_0());
  }
  var gridColumn$delegate;
  function set_gridColumnEnd(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridColumnEnd$delegate.setValue_a8togt_k$(_this__u8e3s4, gridColumnEnd$factory(), _set____db54di);
  }
  function get_gridColumnEnd(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridColumnEnd$delegate.getValue_98unww_k$(_this__u8e3s4, gridColumnEnd$factory_0());
  }
  var gridColumnEnd$delegate;
  function set_gridColumnStart(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridColumnStart$delegate.setValue_a8togt_k$(_this__u8e3s4, gridColumnStart$factory(), _set____db54di);
  }
  function get_gridColumnStart(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridColumnStart$delegate.getValue_98unww_k$(_this__u8e3s4, gridColumnStart$factory_0());
  }
  var gridColumnStart$delegate;
  function set_gridRow(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridRow$delegate.setValue_a8togt_k$(_this__u8e3s4, gridRow$factory(), _set____db54di);
  }
  function get_gridRow(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridRow$delegate.getValue_98unww_k$(_this__u8e3s4, gridRow$factory_0());
  }
  var gridRow$delegate;
  function set_gridRowEnd(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridRowEnd$delegate.setValue_a8togt_k$(_this__u8e3s4, gridRowEnd$factory(), _set____db54di);
  }
  function get_gridRowEnd(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridRowEnd$delegate.getValue_98unww_k$(_this__u8e3s4, gridRowEnd$factory_0());
  }
  var gridRowEnd$delegate;
  function set_gridRowStart(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridRowStart$delegate.setValue_a8togt_k$(_this__u8e3s4, gridRowStart$factory(), _set____db54di);
  }
  function get_gridRowStart(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridRowStart$delegate.getValue_98unww_k$(_this__u8e3s4, gridRowStart$factory_0());
  }
  var gridRowStart$delegate;
  function set_gridTemplate(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridTemplate$delegate.setValue_a8togt_k$(_this__u8e3s4, gridTemplate$factory(), _set____db54di);
  }
  function get_gridTemplate(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridTemplate$delegate.getValue_98unww_k$(_this__u8e3s4, gridTemplate$factory_0());
  }
  var gridTemplate$delegate;
  function set_gridTemplateAreas(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridTemplateAreas$delegate.setValue_a8togt_k$(_this__u8e3s4, gridTemplateAreas$factory(), _set____db54di);
  }
  function get_gridTemplateAreas(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridTemplateAreas$delegate.getValue_98unww_k$(_this__u8e3s4, gridTemplateAreas$factory_0());
  }
  var gridTemplateAreas$delegate;
  function set_gridTemplateColumns(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridTemplateColumns$delegate.setValue_a8togt_k$(_this__u8e3s4, gridTemplateColumns$factory(), _set____db54di);
  }
  function get_gridTemplateColumns(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridTemplateColumns$delegate.getValue_98unww_k$(_this__u8e3s4, gridTemplateColumns$factory_0());
  }
  var gridTemplateColumns$delegate;
  function set_gridTemplateRows(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridTemplateRows$delegate.setValue_a8togt_k$(_this__u8e3s4, gridTemplateRows$factory(), _set____db54di);
  }
  function get_gridTemplateRows(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return gridTemplateRows$delegate.getValue_98unww_k$(_this__u8e3s4, gridTemplateRows$factory_0());
  }
  var gridTemplateRows$delegate;
  function set_height(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return height$delegate.setValue_a8togt_k$(_this__u8e3s4, height$factory(), _set____db54di);
  }
  function get_height(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return height$delegate.getValue_98unww_k$(_this__u8e3s4, height$factory_0());
  }
  var height$delegate;
  function set_hyphens(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return hyphens$delegate.setValue_a8togt_k$(_this__u8e3s4, hyphens$factory(), _set____db54di);
  }
  function get_hyphens(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return hyphens$delegate.getValue_98unww_k$(_this__u8e3s4, hyphens$factory_0());
  }
  var hyphens$delegate;
  function set_inset(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return inset$delegate.setValue_a8togt_k$(_this__u8e3s4, inset$factory(), _set____db54di);
  }
  function get_inset(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return inset$delegate.getValue_98unww_k$(_this__u8e3s4, inset$factory_0());
  }
  var inset$delegate;
  function set_isolation(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return isolation$delegate.setValue_a8togt_k$(_this__u8e3s4, isolation$factory(), _set____db54di);
  }
  function get_isolation(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return isolation$delegate.getValue_98unww_k$(_this__u8e3s4, isolation$factory_0());
  }
  var isolation$delegate;
  function set_justifyContent(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return justifyContent$delegate.setValue_a8togt_k$(_this__u8e3s4, justifyContent$factory(), _set____db54di);
  }
  function get_justifyContent(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return justifyContent$delegate.getValue_98unww_k$(_this__u8e3s4, justifyContent$factory_0());
  }
  var justifyContent$delegate;
  function set_justifyItems(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return justifyItems$delegate.setValue_a8togt_k$(_this__u8e3s4, justifyItems$factory(), _set____db54di);
  }
  function get_justifyItems(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return justifyItems$delegate.getValue_98unww_k$(_this__u8e3s4, justifyItems$factory_0());
  }
  var justifyItems$delegate;
  function set_left(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return left$delegate.setValue_a8togt_k$(_this__u8e3s4, left$factory(), _set____db54di);
  }
  function get_left(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return left$delegate.getValue_98unww_k$(_this__u8e3s4, left$factory_0());
  }
  var left$delegate;
  function set_letterSpacing(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return letterSpacing$delegate.setValue_a8togt_k$(_this__u8e3s4, letterSpacing$factory(), _set____db54di);
  }
  function get_letterSpacing(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return letterSpacing$delegate.getValue_98unww_k$(_this__u8e3s4, letterSpacing$factory_0());
  }
  var letterSpacing$delegate;
  function set_lineHeight(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return lineHeight$delegate.setValue_a8togt_k$(_this__u8e3s4, lineHeight$factory(), _set____db54di);
  }
  function get_lineHeight(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return lineHeight$delegate.getValue_98unww_k$(_this__u8e3s4, lineHeight$factory_0());
  }
  var lineHeight$delegate;
  function set_listStyleType(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return listStyleType$delegate.setValue_a8togt_k$(_this__u8e3s4, listStyleType$factory(), _set____db54di);
  }
  function get_listStyleType(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return listStyleType$delegate.getValue_98unww_k$(_this__u8e3s4, listStyleType$factory_0());
  }
  var listStyleType$delegate;
  function set_margin(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return margin$delegate.setValue_a8togt_k$(_this__u8e3s4, margin$factory(), _set____db54di);
  }
  function get_margin(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return margin$delegate.getValue_98unww_k$(_this__u8e3s4, margin$factory_0());
  }
  var margin$delegate;
  function set_marginTop(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return marginTop$delegate.setValue_a8togt_k$(_this__u8e3s4, marginTop$factory(), _set____db54di);
  }
  function get_marginTop(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return marginTop$delegate.getValue_98unww_k$(_this__u8e3s4, marginTop$factory_0());
  }
  var marginTop$delegate;
  function set_marginRight(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return marginRight$delegate.setValue_a8togt_k$(_this__u8e3s4, marginRight$factory(), _set____db54di);
  }
  function get_marginRight(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return marginRight$delegate.getValue_98unww_k$(_this__u8e3s4, marginRight$factory_0());
  }
  var marginRight$delegate;
  function set_marginBottom(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return marginBottom$delegate.setValue_a8togt_k$(_this__u8e3s4, marginBottom$factory(), _set____db54di);
  }
  function get_marginBottom(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return marginBottom$delegate.getValue_98unww_k$(_this__u8e3s4, marginBottom$factory_0());
  }
  var marginBottom$delegate;
  function set_marginLeft(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return marginLeft$delegate.setValue_a8togt_k$(_this__u8e3s4, marginLeft$factory(), _set____db54di);
  }
  function get_marginLeft(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return marginLeft$delegate.getValue_98unww_k$(_this__u8e3s4, marginLeft$factory_0());
  }
  var marginLeft$delegate;
  function set_minWidth(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return minWidth$delegate.setValue_a8togt_k$(_this__u8e3s4, minWidth$factory(), _set____db54di);
  }
  function get_minWidth(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return minWidth$delegate.getValue_98unww_k$(_this__u8e3s4, minWidth$factory_0());
  }
  var minWidth$delegate;
  function set_maxWidth(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return maxWidth$delegate.setValue_a8togt_k$(_this__u8e3s4, maxWidth$factory(), _set____db54di);
  }
  function get_maxWidth(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return maxWidth$delegate.getValue_98unww_k$(_this__u8e3s4, maxWidth$factory_0());
  }
  var maxWidth$delegate;
  function set_minHeight(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return minHeight$delegate.setValue_a8togt_k$(_this__u8e3s4, minHeight$factory(), _set____db54di);
  }
  function get_minHeight(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return minHeight$delegate.getValue_98unww_k$(_this__u8e3s4, minHeight$factory_0());
  }
  var minHeight$delegate;
  function set_maxHeight(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return maxHeight$delegate.setValue_a8togt_k$(_this__u8e3s4, maxHeight$factory(), _set____db54di);
  }
  function get_maxHeight(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return maxHeight$delegate.getValue_98unww_k$(_this__u8e3s4, maxHeight$factory_0());
  }
  var maxHeight$delegate;
  function set_objectFit(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return objectFit$delegate.setValue_a8togt_k$(_this__u8e3s4, objectFit$factory(), _set____db54di);
  }
  function get_objectFit(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return objectFit$delegate.getValue_98unww_k$(_this__u8e3s4, objectFit$factory_0());
  }
  var objectFit$delegate;
  function set_objectPosition(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return objectPosition$delegate.setValue_a8togt_k$(_this__u8e3s4, objectPosition$factory(), _set____db54di);
  }
  function get_objectPosition(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return objectPosition$delegate.getValue_98unww_k$(_this__u8e3s4, objectPosition$factory_0());
  }
  var objectPosition$delegate;
  function set_opacity(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return opacity$delegate.setValue_a8togt_k$(_this__u8e3s4, opacity$factory(), _set____db54di);
  }
  function get_opacity(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return opacity$delegate.getValue_98unww_k$(_this__u8e3s4, opacity$factory_0());
  }
  var opacity$delegate;
  function set_order(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return order$delegate.setValue_a8togt_k$(_this__u8e3s4, order$factory(), _set____db54di);
  }
  function get_order(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return order$delegate.getValue_98unww_k$(_this__u8e3s4, order$factory_0());
  }
  var order$delegate;
  function set_outline(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return outline$delegate.setValue_a8togt_k$(_this__u8e3s4, outline$factory(), _set____db54di);
  }
  function get_outline(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return outline$delegate.getValue_98unww_k$(_this__u8e3s4, outline$factory_0());
  }
  var outline$delegate;
  function set_outlineColor(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return outlineColor$delegate.setValue_a8togt_k$(_this__u8e3s4, outlineColor$factory(), _set____db54di);
  }
  function get_outlineColor(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return outlineColor$delegate.getValue_98unww_k$(_this__u8e3s4, outlineColor$factory_0());
  }
  var outlineColor$delegate;
  function set_outlineOffset(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return outlineOffset$delegate.setValue_a8togt_k$(_this__u8e3s4, outlineOffset$factory(), _set____db54di);
  }
  function get_outlineOffset(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return outlineOffset$delegate.getValue_98unww_k$(_this__u8e3s4, outlineOffset$factory_0());
  }
  var outlineOffset$delegate;
  function set_outlineStyle(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return outlineStyle$delegate.setValue_a8togt_k$(_this__u8e3s4, outlineStyle$factory(), _set____db54di);
  }
  function get_outlineStyle(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return outlineStyle$delegate.getValue_98unww_k$(_this__u8e3s4, outlineStyle$factory_0());
  }
  var outlineStyle$delegate;
  function set_outlineWidth(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return outlineWidth$delegate.setValue_a8togt_k$(_this__u8e3s4, outlineWidth$factory(), _set____db54di);
  }
  function get_outlineWidth(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return outlineWidth$delegate.getValue_98unww_k$(_this__u8e3s4, outlineWidth$factory_0());
  }
  var outlineWidth$delegate;
  function set_overflow(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return overflow$delegate.setValue_a8togt_k$(_this__u8e3s4, overflow$factory(), _set____db54di);
  }
  function get_overflow(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return overflow$delegate.getValue_98unww_k$(_this__u8e3s4, overflow$factory_0());
  }
  var overflow$delegate;
  function set_overflowX(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return overflowX$delegate.setValue_a8togt_k$(_this__u8e3s4, overflowX$factory(), _set____db54di);
  }
  function get_overflowX(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return overflowX$delegate.getValue_98unww_k$(_this__u8e3s4, overflowX$factory_0());
  }
  var overflowX$delegate;
  function set_overflowY(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return overflowY$delegate.setValue_a8togt_k$(_this__u8e3s4, overflowY$factory(), _set____db54di);
  }
  function get_overflowY(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return overflowY$delegate.getValue_98unww_k$(_this__u8e3s4, overflowY$factory_0());
  }
  var overflowY$delegate;
  function set_overflowWrap(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return overflowWrap$delegate.setValue_a8togt_k$(_this__u8e3s4, overflowWrap$factory(), _set____db54di);
  }
  function get_overflowWrap(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return overflowWrap$delegate.getValue_98unww_k$(_this__u8e3s4, overflowWrap$factory_0());
  }
  var overflowWrap$delegate;
  function set_overscrollBehavior(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return overscrollBehavior$delegate.setValue_a8togt_k$(_this__u8e3s4, overscrollBehavior$factory(), _set____db54di);
  }
  function get_overscrollBehavior(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return overscrollBehavior$delegate.getValue_98unww_k$(_this__u8e3s4, overscrollBehavior$factory_0());
  }
  var overscrollBehavior$delegate;
  function set_padding(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return padding$delegate.setValue_a8togt_k$(_this__u8e3s4, padding$factory(), _set____db54di);
  }
  function get_padding(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return padding$delegate.getValue_98unww_k$(_this__u8e3s4, padding$factory_0());
  }
  var padding$delegate;
  function set_paddingTop(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return paddingTop$delegate.setValue_a8togt_k$(_this__u8e3s4, paddingTop$factory(), _set____db54di);
  }
  function get_paddingTop(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return paddingTop$delegate.getValue_98unww_k$(_this__u8e3s4, paddingTop$factory_0());
  }
  var paddingTop$delegate;
  function set_paddingRight(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return paddingRight$delegate.setValue_a8togt_k$(_this__u8e3s4, paddingRight$factory(), _set____db54di);
  }
  function get_paddingRight(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return paddingRight$delegate.getValue_98unww_k$(_this__u8e3s4, paddingRight$factory_0());
  }
  var paddingRight$delegate;
  function set_paddingBottom(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return paddingBottom$delegate.setValue_a8togt_k$(_this__u8e3s4, paddingBottom$factory(), _set____db54di);
  }
  function get_paddingBottom(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return paddingBottom$delegate.getValue_98unww_k$(_this__u8e3s4, paddingBottom$factory_0());
  }
  var paddingBottom$delegate;
  function set_paddingLeft(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return paddingLeft$delegate.setValue_a8togt_k$(_this__u8e3s4, paddingLeft$factory(), _set____db54di);
  }
  function get_paddingLeft(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return paddingLeft$delegate.getValue_98unww_k$(_this__u8e3s4, paddingLeft$factory_0());
  }
  var paddingLeft$delegate;
  function set_pointerEvents(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return pointerEvents$delegate.setValue_a8togt_k$(_this__u8e3s4, pointerEvents$factory(), _set____db54di);
  }
  function get_pointerEvents(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return pointerEvents$delegate.getValue_98unww_k$(_this__u8e3s4, pointerEvents$factory_0());
  }
  var pointerEvents$delegate;
  function set_position(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return position$delegate.setValue_a8togt_k$(_this__u8e3s4, position$factory(), _set____db54di);
  }
  function get_position(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return position$delegate.getValue_98unww_k$(_this__u8e3s4, position$factory_0());
  }
  var position$delegate;
  function set_resize(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return resize$delegate.setValue_a8togt_k$(_this__u8e3s4, resize$factory(), _set____db54di);
  }
  function get_resize(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return resize$delegate.getValue_98unww_k$(_this__u8e3s4, resize$factory_0());
  }
  var resize$delegate;
  function set_right(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return right$delegate.setValue_a8togt_k$(_this__u8e3s4, right$factory(), _set____db54di);
  }
  function get_right(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return right$delegate.getValue_98unww_k$(_this__u8e3s4, right$factory_0());
  }
  var right$delegate;
  function set_rowGap(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return rowGap$delegate.setValue_a8togt_k$(_this__u8e3s4, rowGap$factory(), _set____db54di);
  }
  function get_rowGap(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return rowGap$delegate.getValue_98unww_k$(_this__u8e3s4, rowGap$factory_0());
  }
  var rowGap$delegate;
  function set_scrollBehavior(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return scrollBehavior$delegate.setValue_a8togt_k$(_this__u8e3s4, scrollBehavior$factory(), _set____db54di);
  }
  function get_scrollBehavior(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return scrollBehavior$delegate.getValue_98unww_k$(_this__u8e3s4, scrollBehavior$factory_0());
  }
  var scrollBehavior$delegate;
  function set_src(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return src$delegate.setValue_a8togt_k$(_this__u8e3s4, src$factory(), _set____db54di);
  }
  function get_src(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return src$delegate.getValue_98unww_k$(_this__u8e3s4, src$factory_0());
  }
  var src$delegate;
  function set_tableLayout(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return tableLayout$delegate.setValue_a8togt_k$(_this__u8e3s4, tableLayout$factory(), _set____db54di);
  }
  function get_tableLayout(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return tableLayout$delegate.getValue_98unww_k$(_this__u8e3s4, tableLayout$factory_0());
  }
  var tableLayout$delegate;
  function set_textAlign(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return textAlign$delegate.setValue_a8togt_k$(_this__u8e3s4, textAlign$factory(), _set____db54di);
  }
  function get_textAlign(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return textAlign$delegate.getValue_98unww_k$(_this__u8e3s4, textAlign$factory_0());
  }
  var textAlign$delegate;
  function set_textDecoration(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return textDecoration$delegate.setValue_a8togt_k$(_this__u8e3s4, textDecoration$factory(), _set____db54di);
  }
  function get_textDecoration(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return textDecoration$delegate.getValue_98unww_k$(_this__u8e3s4, textDecoration$factory_0());
  }
  var textDecoration$delegate;
  function set_textOverflow(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return textOverflow$delegate.setValue_a8togt_k$(_this__u8e3s4, textOverflow$factory(), _set____db54di);
  }
  function get_textOverflow(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return textOverflow$delegate.getValue_98unww_k$(_this__u8e3s4, textOverflow$factory_0());
  }
  var textOverflow$delegate;
  function set_textTransform(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return textTransform$delegate.setValue_a8togt_k$(_this__u8e3s4, textTransform$factory(), _set____db54di);
  }
  function get_textTransform(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return textTransform$delegate.getValue_98unww_k$(_this__u8e3s4, textTransform$factory_0());
  }
  var textTransform$delegate;
  function set_top(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return top$delegate.setValue_a8togt_k$(_this__u8e3s4, top$factory(), _set____db54di);
  }
  function get_top(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return top$delegate.getValue_98unww_k$(_this__u8e3s4, top$factory_0());
  }
  var top$delegate;
  function set_transform(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return transform$delegate.setValue_a8togt_k$(_this__u8e3s4, transform$factory(), _set____db54di);
  }
  function get_transform(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return transform$delegate.getValue_98unww_k$(_this__u8e3s4, transform$factory_0());
  }
  var transform$delegate;
  function set_transition(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return transition$delegate.setValue_a8togt_k$(_this__u8e3s4, transition$factory(), _set____db54di);
  }
  function get_transition(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return transition$delegate.getValue_98unww_k$(_this__u8e3s4, transition$factory_0());
  }
  var transition$delegate;
  function set_transitionDelay(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return transitionDelay$delegate.setValue_a8togt_k$(_this__u8e3s4, transitionDelay$factory(), _set____db54di);
  }
  function get_transitionDelay(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return transitionDelay$delegate.getValue_98unww_k$(_this__u8e3s4, transitionDelay$factory_0());
  }
  var transitionDelay$delegate;
  function set_transitionDuration(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return transitionDuration$delegate.setValue_a8togt_k$(_this__u8e3s4, transitionDuration$factory(), _set____db54di);
  }
  function get_transitionDuration(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return transitionDuration$delegate.getValue_98unww_k$(_this__u8e3s4, transitionDuration$factory_0());
  }
  var transitionDuration$delegate;
  function set_transitionProperty(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return transitionProperty$delegate.setValue_a8togt_k$(_this__u8e3s4, transitionProperty$factory(), _set____db54di);
  }
  function get_transitionProperty(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return transitionProperty$delegate.getValue_98unww_k$(_this__u8e3s4, transitionProperty$factory_0());
  }
  var transitionProperty$delegate;
  function set_transitionTimingFunction(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return transitionTimingFunction$delegate.setValue_a8togt_k$(_this__u8e3s4, transitionTimingFunction$factory(), _set____db54di);
  }
  function get_transitionTimingFunction(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return transitionTimingFunction$delegate.getValue_98unww_k$(_this__u8e3s4, transitionTimingFunction$factory_0());
  }
  var transitionTimingFunction$delegate;
  function set_userSelect(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return userSelect$delegate.setValue_a8togt_k$(_this__u8e3s4, userSelect$factory(), _set____db54di);
  }
  function get_userSelect(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return userSelect$delegate.getValue_98unww_k$(_this__u8e3s4, userSelect$factory_0());
  }
  var userSelect$delegate;
  function set_verticalAlign(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return verticalAlign$delegate.setValue_a8togt_k$(_this__u8e3s4, verticalAlign$factory(), _set____db54di);
  }
  function get_verticalAlign(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return verticalAlign$delegate.getValue_98unww_k$(_this__u8e3s4, verticalAlign$factory_0());
  }
  var verticalAlign$delegate;
  function set_visibility(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return visibility$delegate.setValue_a8togt_k$(_this__u8e3s4, visibility$factory(), _set____db54di);
  }
  function get_visibility(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return visibility$delegate.getValue_98unww_k$(_this__u8e3s4, visibility$factory_0());
  }
  var visibility$delegate;
  function set_whiteSpace(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return whiteSpace$delegate.setValue_a8togt_k$(_this__u8e3s4, whiteSpace$factory(), _set____db54di);
  }
  function get_whiteSpace(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return whiteSpace$delegate.getValue_98unww_k$(_this__u8e3s4, whiteSpace$factory_0());
  }
  var whiteSpace$delegate;
  function set_width(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return width$delegate.setValue_a8togt_k$(_this__u8e3s4, width$factory(), _set____db54di);
  }
  function get_width(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return width$delegate.getValue_98unww_k$(_this__u8e3s4, width$factory_0());
  }
  var width$delegate;
  function set_wordBreak(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return wordBreak$delegate.setValue_a8togt_k$(_this__u8e3s4, wordBreak$factory(), _set____db54di);
  }
  function get_wordBreak(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return wordBreak$delegate.getValue_98unww_k$(_this__u8e3s4, wordBreak$factory_0());
  }
  var wordBreak$delegate;
  function set_wordSpacing(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return wordSpacing$delegate.setValue_a8togt_k$(_this__u8e3s4, wordSpacing$factory(), _set____db54di);
  }
  function get_wordSpacing(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return wordSpacing$delegate.getValue_98unww_k$(_this__u8e3s4, wordSpacing$factory_0());
  }
  var wordSpacing$delegate;
  function set_wordWrap(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return wordWrap$delegate.setValue_a8togt_k$(_this__u8e3s4, wordWrap$factory(), _set____db54di);
  }
  function get_wordWrap(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return wordWrap$delegate.getValue_98unww_k$(_this__u8e3s4, wordWrap$factory_0());
  }
  var wordWrap$delegate;
  function set_zIndex(_this__u8e3s4, _set____db54di) {
    _init_properties_StyledElement_kt__jfdzyh();
    return zIndex$delegate.setValue_a8togt_k$(_this__u8e3s4, zIndex$factory(), _set____db54di);
  }
  function get_zIndex(_this__u8e3s4) {
    _init_properties_StyledElement_kt__jfdzyh();
    return zIndex$delegate.getValue_98unww_k$(_this__u8e3s4, zIndex$factory_0());
  }
  var zIndex$delegate;
  ...
  protoOf(CssProperty).getValue_98unww_k$ = function (thisRef, property) {
    var tmp0_safe_receiver = this.default_1;
    if (tmp0_safe_receiver == null)
      null;
    else {
      // Inline function 'kotlin.let' call
      if (!thisRef.get_declarations_u0xo5e_k$().containsKey_w445h6_k$(property.callableName)) {
        var tmp = thisRef.get_declarations_u0xo5e_k$();
        var tmp_0 = property.callableName;
        var tmp_1 = tmp0_safe_receiver();
        tmp.set_xfbcfe_k$(tmp_0, !(tmp_1 == null) ? tmp_1 : THROW_CCE());
      }
    }
    var tmp_2 = thisRef.get_declarations_u0xo5e_k$().get_6bo4tg_k$(property.callableName);
    return (tmp_2 == null ? true : !(tmp_2 == null)) ? tmp_2 : THROW_CCE();
  };
  protoOf(CssProperty).setValue_a8togt_k$ = function (thisRef, property, value) {
    var tmp = thisRef.get_declarations_u0xo5e_k$();
    var tmp_0 = property.callableName;
    tmp.set_xfbcfe_k$(tmp_0, !(value == null) ? value : THROW_CCE());
  };
  ...
  function _get_stringDecl__efq3kg($this) {
    ...
    if (tmp0_elvis_lhs == null) {
      ...
      var _iterator__ex2g4s = $this.get_entries_p20ztl_k$().iterator_jk1svi_k$();
      while (_iterator__ex2g4s.hasNext_bitz1p_k$()) {
        ...
        this_0.append_22ad7x_k$(hyphenize(k) + ': ' + toString(v) + ';\n');
      }
      // Inline function 'kotlin.also' call
      var this_1 = this_0.toString();
      $this.stringDecl_1 = this_1;
      tmp = this_1;
    } else {
      tmp = tmp0_elvis_lhs;
    }
  ...
  protoOf(CssDeclarations).clear_j9egeb_k$ = function () {
    this.$$delegate_0__1.clear_j9egeb_k$();
  };
  protoOf(CssDeclarations).containsKey_w445h6_k$ = function (key) {
    return this.$$delegate_0__1.containsKey_aw81wo_k$(key);
  };
  protoOf(CssDeclarations).containsKey_aw81wo_k$ = function (key) {
  ...
  protoOf(CssDeclarations).containsValue_yf2ykl_k$ = function (value) {
    if (!!(value == null))
      return false;
    return this.containsValue_9ayjf8_k$(!(value == null) ? value : THROW_CCE());
  };
  protoOf(CssDeclarations).get_6bo4tg_k$ = function (key) {
    return this.$$delegate_0__1.get_wei43m_k$(key);
  };
  protoOf(CssDeclarations).get_wei43m_k$ = function (key) {
    if (!(!(key == null) ? typeof key === 'string' : false))
      return null;
  ...
  protoOf(CssDeclarations).put_th2xw3_k$ = function (key, value) {
    return this.$$delegate_0__1.put_4fpzoq_k$(key, value);
  };
  protoOf(CssDeclarations).put_4fpzoq_k$ = function (key, value) {
    var tmp = (!(key == null) ? typeof key === 'string' : false) ? key : THROW_CCE();
    return this.put_th2xw3_k$(tmp, !(value == null) ? value : THROW_CCE());
  };
  protoOf(CssDeclarations).putAll_gyyze7_k$ = function (from) {
    this.$$delegate_0__1.putAll_wgg6cj_k$(from);
  };
  protoOf(CssDeclarations).putAll_wgg6cj_k$ = function (from) {
    return this.putAll_gyyze7_k$(from);
  };
  protoOf(CssDeclarations).remove_z05dva_k$ = function (key) {
    return this.$$delegate_0__1.remove_gppy8k_k$(key);
  };
  protoOf(CssDeclarations).remove_gppy8k_k$ = function (key) {
    if (!(!(key == null) ? typeof key === 'string' : false))
      return null;
  ...
  protoOf(CssDeclarations).equals = function (other) {
    ...
    $l$block_0: {
      ...
      if (hashCode(this) === hashCode(other)) {
        tmp = _get_stringDecl__efq3kg(this) == _get_stringDecl__efq3kg(other);
      } else {
        tmp = false;
      }
      tmp$ret$0 = tmp;
  ...
  protoOf(CssDeclarations).hashCode = function () {
    ...
    var tmp0_safe_receiver = _get_stringDecl__efq3kg(this);
  ...
  protoOf(CssDeclarations).set_xfbcfe_k$ = function (name, value) {
    this.put_th2xw3_k$(name, value);
    this.stringDecl_1 = null;
  };
  ...
  function get_html() {
    ...
    return html$delegate.getValue_n1n307_k$(null, html$factory());
  }
  var html$delegate;
  function get_base() {
    _init_properties_TagSelectors_kt__3okvom();
    return base$delegate.getValue_n1n307_k$(null, base$factory());
  }
  var base$delegate;
  function get_head() {
    _init_properties_TagSelectors_kt__3okvom();
    return head$delegate.getValue_n1n307_k$(null, head$factory());
  }
  var head$delegate;
  function get_link() {
    _init_properties_TagSelectors_kt__3okvom();
    return link$delegate.getValue_n1n307_k$(null, link$factory());
  }
  var link$delegate;
  function get_meta() {
    _init_properties_TagSelectors_kt__3okvom();
    return meta$delegate.getValue_n1n307_k$(null, meta$factory());
  }
  var meta$delegate;
  function get_style() {
    _init_properties_TagSelectors_kt__3okvom();
    return style$delegate.getValue_n1n307_k$(null, style$factory());
  }
  var style$delegate;
  function get_title() {
    _init_properties_TagSelectors_kt__3okvom();
    return title$delegate.getValue_n1n307_k$(null, title$factory());
  }
  var title$delegate;
  function get_body() {
    _init_properties_TagSelectors_kt__3okvom();
    return body$delegate.getValue_n1n307_k$(null, body$factory());
  }
  var body$delegate;
  function get_address() {
    _init_properties_TagSelectors_kt__3okvom();
    return address$delegate.getValue_n1n307_k$(null, address$factory());
  }
  var address$delegate;
  function get_article() {
    _init_properties_TagSelectors_kt__3okvom();
    return article$delegate.getValue_n1n307_k$(null, article$factory());
  }
  var article$delegate;
  function get_aside() {
    _init_properties_TagSelectors_kt__3okvom();
    return aside$delegate.getValue_n1n307_k$(null, aside$factory());
  }
  var aside$delegate;
  function get_footer() {
    _init_properties_TagSelectors_kt__3okvom();
    return footer$delegate.getValue_n1n307_k$(null, footer$factory());
  }
  var footer$delegate;
  function get_header() {
    _init_properties_TagSelectors_kt__3okvom();
    return header$delegate.getValue_n1n307_k$(null, header$factory());
  }
  var header$delegate;
  function get_h1() {
    _init_properties_TagSelectors_kt__3okvom();
    return h1$delegate.getValue_n1n307_k$(null, h1$factory());
  }
  var h1$delegate;
  function get_h2() {
    _init_properties_TagSelectors_kt__3okvom();
    return h2$delegate.getValue_n1n307_k$(null, h2$factory());
  }
  var h2$delegate;
  function get_h3() {
    _init_properties_TagSelectors_kt__3okvom();
    return h3$delegate.getValue_n1n307_k$(null, h3$factory());
  }
  var h3$delegate;
  function get_h4() {
    _init_properties_TagSelectors_kt__3okvom();
    return h4$delegate.getValue_n1n307_k$(null, h4$factory());
  }
  var h4$delegate;
  function get_h5() {
    _init_properties_TagSelectors_kt__3okvom();
    return h5$delegate.getValue_n1n307_k$(null, h5$factory());
  }
  var h5$delegate;
  function get_h6() {
    _init_properties_TagSelectors_kt__3okvom();
    return h6$delegate.getValue_n1n307_k$(null, h6$factory());
  }
  var h6$delegate;
  function get_main() {
    _init_properties_TagSelectors_kt__3okvom();
    return main$delegate.getValue_n1n307_k$(null, main$factory());
  }
  var main$delegate;
  function get_nav() {
    _init_properties_TagSelectors_kt__3okvom();
    return nav$delegate.getValue_n1n307_k$(null, nav$factory());
  }
  var nav$delegate;
  function get_section() {
    _init_properties_TagSelectors_kt__3okvom();
    return section$delegate.getValue_n1n307_k$(null, section$factory());
  }
  var section$delegate;
  function get_blockquote() {
    _init_properties_TagSelectors_kt__3okvom();
    return blockquote$delegate.getValue_n1n307_k$(null, blockquote$factory());
  }
  var blockquote$delegate;
  function get_dd() {
    _init_properties_TagSelectors_kt__3okvom();
    return dd$delegate.getValue_n1n307_k$(null, dd$factory());
  }
  var dd$delegate;
  function get_div() {
    _init_properties_TagSelectors_kt__3okvom();
    return div$delegate.getValue_n1n307_k$(null, div$factory());
  }
  var div$delegate;
  function get_dl() {
    _init_properties_TagSelectors_kt__3okvom();
    return dl$delegate.getValue_n1n307_k$(null, dl$factory());
  }
  var dl$delegate;
  function get_dt() {
    _init_properties_TagSelectors_kt__3okvom();
    return dt$delegate.getValue_n1n307_k$(null, dt$factory());
  }
  var dt$delegate;
  function get_figcaption() {
    _init_properties_TagSelectors_kt__3okvom();
    return figcaption$delegate.getValue_n1n307_k$(null, figcaption$factory());
  }
  var figcaption$delegate;
  function get_figure() {
    _init_properties_TagSelectors_kt__3okvom();
    return figure$delegate.getValue_n1n307_k$(null, figure$factory());
  }
  var figure$delegate;
  function get_hr() {
    _init_properties_TagSelectors_kt__3okvom();
    return hr$delegate.getValue_n1n307_k$(null, hr$factory());
  }
  var hr$delegate;
  function get_li() {
    _init_properties_TagSelectors_kt__3okvom();
    return li$delegate.getValue_n1n307_k$(null, li$factory());
  }
  var li$delegate;
  function get_ol() {
    _init_properties_TagSelectors_kt__3okvom();
    return ol$delegate.getValue_n1n307_k$(null, ol$factory());
  }
  var ol$delegate;
  function get_p() {
    _init_properties_TagSelectors_kt__3okvom();
    return p$delegate.getValue_n1n307_k$(null, p$factory());
  }
  var p$delegate;
  function get_pre() {
    _init_properties_TagSelectors_kt__3okvom();
    return pre$delegate.getValue_n1n307_k$(null, pre$factory());
  }
  var pre$delegate;
  function get_ul() {
    _init_properties_TagSelectors_kt__3okvom();
    return ul$delegate.getValue_n1n307_k$(null, ul$factory());
  }
  var ul$delegate;
  function get_a() {
    _init_properties_TagSelectors_kt__3okvom();
    return a$delegate.getValue_n1n307_k$(null, a$factory());
  }
  var a$delegate;
  function get_abbr() {
    _init_properties_TagSelectors_kt__3okvom();
    return abbr$delegate.getValue_n1n307_k$(null, abbr$factory());
  }
  var abbr$delegate;
  function get_b() {
    _init_properties_TagSelectors_kt__3okvom();
    return b$delegate.getValue_n1n307_k$(null, b$factory());
  }
  var b$delegate;
  function get_bdi() {
    _init_properties_TagSelectors_kt__3okvom();
    return bdi$delegate.getValue_n1n307_k$(null, bdi$factory());
  }
  var bdi$delegate;
  function get_bdo() {
    _init_properties_TagSelectors_kt__3okvom();
    return bdo$delegate.getValue_n1n307_k$(null, bdo$factory());
  }
  var bdo$delegate;
  function get_br() {
    _init_properties_TagSelectors_kt__3okvom();
    return br$delegate.getValue_n1n307_k$(null, br$factory());
  }
  var br$delegate;
  function get_cite() {
    _init_properties_TagSelectors_kt__3okvom();
    return cite$delegate.getValue_n1n307_k$(null, cite$factory());
  }
  var cite$delegate;
  function get_code() {
    _init_properties_TagSelectors_kt__3okvom();
    return code$delegate.getValue_n1n307_k$(null, code$factory());
  }
  var code$delegate;
  function get_data() {
    _init_properties_TagSelectors_kt__3okvom();
    return data$delegate.getValue_n1n307_k$(null, data$factory());
  }
  var data$delegate;
  function get_dfn() {
    _init_properties_TagSelectors_kt__3okvom();
    return dfn$delegate.getValue_n1n307_k$(null, dfn$factory());
  }
  var dfn$delegate;
  function get_em() {
    _init_properties_TagSelectors_kt__3okvom();
    return em$delegate.getValue_n1n307_k$(null, em$factory());
  }
  var em$delegate;
  function get_i() {
    _init_properties_TagSelectors_kt__3okvom();
    return i$delegate.getValue_n1n307_k$(null, i$factory());
  }
  var i$delegate;
  function get_kbd() {
    _init_properties_TagSelectors_kt__3okvom();
    return kbd$delegate.getValue_n1n307_k$(null, kbd$factory());
  }
  var kbd$delegate;
  function get_mark() {
    _init_properties_TagSelectors_kt__3okvom();
    return mark$delegate.getValue_n1n307_k$(null, mark$factory());
  }
  var mark$delegate;
  function get_q() {
    _init_properties_TagSelectors_kt__3okvom();
    return q$delegate.getValue_n1n307_k$(null, q$factory());
  }
  var q$delegate;
  function get_rb() {
    _init_properties_TagSelectors_kt__3okvom();
    return rb$delegate.getValue_n1n307_k$(null, rb$factory());
  }
  var rb$delegate;
  function get_rp() {
    _init_properties_TagSelectors_kt__3okvom();
    return rp$delegate.getValue_n1n307_k$(null, rp$factory());
  }
  var rp$delegate;
  function get_rt() {
    _init_properties_TagSelectors_kt__3okvom();
    return rt$delegate.getValue_n1n307_k$(null, rt$factory());
  }
  var rt$delegate;
  function get_rtc() {
    _init_properties_TagSelectors_kt__3okvom();
    return rtc$delegate.getValue_n1n307_k$(null, rtc$factory());
  }
  var rtc$delegate;
  function get_ruby() {
    _init_properties_TagSelectors_kt__3okvom();
    return ruby$delegate.getValue_n1n307_k$(null, ruby$factory());
  }
  var ruby$delegate;
  function get_s() {
    _init_properties_TagSelectors_kt__3okvom();
    return s$delegate.getValue_n1n307_k$(null, s$factory());
  }
  var s$delegate;
  function get_samp() {
    _init_properties_TagSelectors_kt__3okvom();
    return samp$delegate.getValue_n1n307_k$(null, samp$factory());
  }
  var samp$delegate;
  function get_small() {
    _init_properties_TagSelectors_kt__3okvom();
    return small$delegate.getValue_n1n307_k$(null, small$factory());
  }
  var small$delegate;
  function get_span() {
    _init_properties_TagSelectors_kt__3okvom();
    return span$delegate.getValue_n1n307_k$(null, span$factory());
  }
  var span$delegate;
  function get_strong() {
    _init_properties_TagSelectors_kt__3okvom();
    return strong$delegate.getValue_n1n307_k$(null, strong$factory());
  }
  var strong$delegate;
  function get_sub() {
    _init_properties_TagSelectors_kt__3okvom();
    return sub$delegate.getValue_n1n307_k$(null, sub$factory());
  }
  var sub$delegate;
  function get_sup() {
    _init_properties_TagSelectors_kt__3okvom();
    return sup$delegate.getValue_n1n307_k$(null, sup$factory());
  }
  var sup$delegate;
  function get_time() {
    _init_properties_TagSelectors_kt__3okvom();
    return time$delegate.getValue_n1n307_k$(null, time$factory());
  }
  var time$delegate;
  function get_u() {
    _init_properties_TagSelectors_kt__3okvom();
    return u$delegate.getValue_n1n307_k$(null, u$factory());
  }
  var u$delegate;
  function get_wbr() {
    _init_properties_TagSelectors_kt__3okvom();
    return wbr$delegate.getValue_n1n307_k$(null, wbr$factory());
  }
  var wbr$delegate;
  function get_area() {
    _init_properties_TagSelectors_kt__3okvom();
    return area$delegate.getValue_n1n307_k$(null, area$factory());
  }
  var area$delegate;
  function get_audio() {
    _init_properties_TagSelectors_kt__3okvom();
    return audio$delegate.getValue_n1n307_k$(null, audio$factory());
  }
  var audio$delegate;
  function get_img() {
    _init_properties_TagSelectors_kt__3okvom();
    return img$delegate.getValue_n1n307_k$(null, img$factory());
  }
  var img$delegate;
  function get_map() {
    _init_properties_TagSelectors_kt__3okvom();
    return map$delegate.getValue_n1n307_k$(null, map$factory());
  }
  var map$delegate;
  function get_track() {
    _init_properties_TagSelectors_kt__3okvom();
    return track$delegate.getValue_n1n307_k$(null, track$factory());
  }
  var track$delegate;
  function get_video() {
    _init_properties_TagSelectors_kt__3okvom();
    return video$delegate.getValue_n1n307_k$(null, video$factory());
  }
  var video$delegate;
  function get_embed() {
    _init_properties_TagSelectors_kt__3okvom();
    return embed$delegate.getValue_n1n307_k$(null, embed$factory());
  }
  var embed$delegate;
  function get_iframe() {
    _init_properties_TagSelectors_kt__3okvom();
    return iframe$delegate.getValue_n1n307_k$(null, iframe$factory());
  }
  var iframe$delegate;
  function get_param() {
    _init_properties_TagSelectors_kt__3okvom();
    return param$delegate.getValue_n1n307_k$(null, param$factory());
  }
  var param$delegate;
  function get_picture() {
    _init_properties_TagSelectors_kt__3okvom();
    return picture$delegate.getValue_n1n307_k$(null, picture$factory());
  }
  var picture$delegate;
  function get_portal() {
    _init_properties_TagSelectors_kt__3okvom();
    return portal$delegate.getValue_n1n307_k$(null, portal$factory());
  }
  var portal$delegate;
  function get_source() {
    _init_properties_TagSelectors_kt__3okvom();
    return source$delegate.getValue_n1n307_k$(null, source$factory());
  }
  var source$delegate;
  function get_svg() {
    _init_properties_TagSelectors_kt__3okvom();
    return svg$delegate.getValue_n1n307_k$(null, svg$factory());
  }
  var svg$delegate;
  function get_math() {
    _init_properties_TagSelectors_kt__3okvom();
    return math$delegate.getValue_n1n307_k$(null, math$factory());
  }
  var math$delegate;
  function get_canvas() {
    _init_properties_TagSelectors_kt__3okvom();
    return canvas$delegate.getValue_n1n307_k$(null, canvas$factory());
  }
  var canvas$delegate;
  function get_noscript() {
    _init_properties_TagSelectors_kt__3okvom();
    return noscript$delegate.getValue_n1n307_k$(null, noscript$factory());
  }
  var noscript$delegate;
  function get_script() {
    _init_properties_TagSelectors_kt__3okvom();
    return script$delegate.getValue_n1n307_k$(null, script$factory());
  }
  var script$delegate;
  function get_del() {
    _init_properties_TagSelectors_kt__3okvom();
    return del$delegate.getValue_n1n307_k$(null, del$factory());
  }
  var del$delegate;
  function get_ins() {
    _init_properties_TagSelectors_kt__3okvom();
    return ins$delegate.getValue_n1n307_k$(null, ins$factory());
  }
  var ins$delegate;
  function get_caption() {
    _init_properties_TagSelectors_kt__3okvom();
    return caption$delegate.getValue_n1n307_k$(null, caption$factory());
  }
  var caption$delegate;
  function get_col() {
    _init_properties_TagSelectors_kt__3okvom();
    return col$delegate.getValue_n1n307_k$(null, col$factory());
  }
  var col$delegate;
  function get_colgroup() {
    _init_properties_TagSelectors_kt__3okvom();
    return colgroup$delegate.getValue_n1n307_k$(null, colgroup$factory());
  }
  var colgroup$delegate;
  function get_table() {
    _init_properties_TagSelectors_kt__3okvom();
    return table$delegate.getValue_n1n307_k$(null, table$factory());
  }
  var table$delegate;
  function get_tbody() {
    _init_properties_TagSelectors_kt__3okvom();
    return tbody$delegate.getValue_n1n307_k$(null, tbody$factory());
  }
  var tbody$delegate;
  function get_td() {
    _init_properties_TagSelectors_kt__3okvom();
    return td$delegate.getValue_n1n307_k$(null, td$factory());
  }
  var td$delegate;
  function get_tfoot() {
    _init_properties_TagSelectors_kt__3okvom();
    return tfoot$delegate.getValue_n1n307_k$(null, tfoot$factory());
  }
  var tfoot$delegate;
  function get_th() {
    _init_properties_TagSelectors_kt__3okvom();
    return th$delegate.getValue_n1n307_k$(null, th$factory());
  }
  var th$delegate;
  function get_thead() {
    _init_properties_TagSelectors_kt__3okvom();
    return thead$delegate.getValue_n1n307_k$(null, thead$factory());
  }
  var thead$delegate;
  function get_tr() {
    _init_properties_TagSelectors_kt__3okvom();
    return tr$delegate.getValue_n1n307_k$(null, tr$factory());
  }
  var tr$delegate;
  function get_button() {
    _init_properties_TagSelectors_kt__3okvom();
    return button$delegate.getValue_n1n307_k$(null, button$factory());
  }
  var button$delegate;
  function get_datalist() {
    _init_properties_TagSelectors_kt__3okvom();
    return datalist$delegate.getValue_n1n307_k$(null, datalist$factory());
  }
  var datalist$delegate;
  function get_fieldset() {
    _init_properties_TagSelectors_kt__3okvom();
    return fieldset$delegate.getValue_n1n307_k$(null, fieldset$factory());
  }
  var fieldset$delegate;
  function get_form() {
    _init_properties_TagSelectors_kt__3okvom();
    return form$delegate.getValue_n1n307_k$(null, form$factory());
  }
  var form$delegate;
  function get_input() {
    _init_properties_TagSelectors_kt__3okvom();
    return input$delegate.getValue_n1n307_k$(null, input$factory());
  }
  var input$delegate;
  function get_label() {
    _init_properties_TagSelectors_kt__3okvom();
    return label$delegate.getValue_n1n307_k$(null, label$factory());
  }
  var label$delegate;
  function get_legend() {
    _init_properties_TagSelectors_kt__3okvom();
    return legend$delegate.getValue_n1n307_k$(null, legend$factory());
  }
  var legend$delegate;
  function get_meter() {
    _init_properties_TagSelectors_kt__3okvom();
    return meter$delegate.getValue_n1n307_k$(null, meter$factory());
  }
  var meter$delegate;
  function get_optgroup() {
    _init_properties_TagSelectors_kt__3okvom();
    return optgroup$delegate.getValue_n1n307_k$(null, optgroup$factory());
  }
  var optgroup$delegate;
  function get_option() {
    _init_properties_TagSelectors_kt__3okvom();
    return option$delegate.getValue_n1n307_k$(null, option$factory());
  }
  var option$delegate;
  function get_output() {
    _init_properties_TagSelectors_kt__3okvom();
    return output$delegate.getValue_n1n307_k$(null, output$factory());
  }
  var output$delegate;
  function get_progress() {
    _init_properties_TagSelectors_kt__3okvom();
    return progress$delegate.getValue_n1n307_k$(null, progress$factory());
  }
  var progress$delegate;
  function get_select() {
    _init_properties_TagSelectors_kt__3okvom();
    return select$delegate.getValue_n1n307_k$(null, select$factory());
  }
  var select$delegate;
  function get_textarea() {
    _init_properties_TagSelectors_kt__3okvom();
    return textarea$delegate.getValue_n1n307_k$(null, textarea$factory());
  }
  var textarea$delegate;
  function get_details() {
    _init_properties_TagSelectors_kt__3okvom();
    return details$delegate.getValue_n1n307_k$(null, details$factory());
  }
  var details$delegate;
  function get_dialog() {
    _init_properties_TagSelectors_kt__3okvom();
    return dialog$delegate.getValue_n1n307_k$(null, dialog$factory());
  }
  var dialog$delegate;
  function get_menu() {
    _init_properties_TagSelectors_kt__3okvom();
    return menu$delegate.getValue_n1n307_k$(null, menu$factory());
  }
  var menu$delegate;
  function get_summary() {
    _init_properties_TagSelectors_kt__3okvom();
    return summary$delegate.getValue_n1n307_k$(null, summary$factory());
  }
  var summary$delegate;
  function get_slot() {
    _init_properties_TagSelectors_kt__3okvom();
    return slot$delegate.getValue_n1n307_k$(null, slot$factory());
  }
  var slot$delegate;
  function get_template() {
    _init_properties_TagSelectors_kt__3okvom();
    return template$delegate.getValue_n1n307_k$(null, template$factory());
  }
  ...
  protoOf(TagSelectorFactory).getValue_n1n307_k$ = function (thisRef, property) {
  ...
  protoOf(Animation).toString = function () {
    return this.duration_1.toString() + ' ' + this.timing_1.toString() + ' ' + this.delay_1.toString() + ' ' + this.iterationCount_1.toString() + ' ' + this.direction_1.toString() + ' ' + this.fillMode_1.toString() + ' ' + this.playState_1.toString() + ' ' + this.name_1;
  };
  ...
  protoOf(BoxShadow).set_color_s9uisg_k$ = function (_set____db54di) {
  ...
  protoOf(BoxShadow).toString = function () {
    ...
    this_0.append_22ad7x_k$(this.offsetX_1.toString() + ' ' + this.offsetY_1.toString() + ' ' + this.blurRadius_1.toString() + ' ' + this.spreadRadius_1.toString() + ' ' + this.color_1.toString());
  ...
  protoOf(TextDecoration).toString = function () {
    ...
    if (this.lines_1.isEmpty_y1axqb_k$()) {
      ...
      // Inline function 'kotlin.apply' call
      var this_0 = StringBuilder_init_$Create$();
      this_0.append_22ad7x_k$(joinToString_0(this.lines_1, ' '));
      var tmp0_safe_receiver = this.style_1;
      if (tmp0_safe_receiver == null)
        null;
      else {
        // Inline function 'kotlin.let' call
        this_0.append_22ad7x_k$(' ' + tmp0_safe_receiver.toString());
      }
      ...
      if (tmp1_safe_receiver == null)
        ...
        // Inline function 'kotlin.let' call
        this_0.append_22ad7x_k$(' ' + tmp1_safe_receiver.toString());
      }
      tmp = this_0.toString();
    }
    return tmp;
  ...
  protoOf(Transition).toString = function () {
    return this.property_1 + ' ' + this.duration_1.toString() + ' ' + this.timing_1.toString() + ' ' + this.delay_1.toString();
  };
  //region block: post-declaration
  protoOf(CssDeclarations).asJsMapView_ii14sm_k$ = asJsMapView;
  protoOf(CssDeclarations).asJsReadonlyMapView_6h4p3w_k$ = asJsReadonlyMapView;
  //endregion
  //region block: init
  ZERO = '0';
  //endregion
